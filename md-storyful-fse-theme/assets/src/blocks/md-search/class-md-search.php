<?php
/**
 * Registers the md-storyful-fse/sample-dynamic block.
 *
...
/**
 *  Class for the md-storyful-fse/md-search block.
 */
class MD_Search extends Block_Base {
	...
	protected function setup_hooks() {
		add_filter( 'md_storyful_fse_gutenberg_blocks_config', array( $this, 'localize_block_data' ) );
	}
		...
		<div <?php echo wp_kses_post( $wrapper_attributes ); ?>>
			<div class="md_search_block">
				...
				<div class="md_search_input">
					...
					get_search_form();
					?>
					<span aria-hidden="true" class="close-search">×</span>
				</div>
			</div>
		</div>
		<?php
