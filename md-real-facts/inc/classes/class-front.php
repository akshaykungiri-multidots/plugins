 ...
 * @subpackage MD_Real_Facts/public
...
class Front {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'md-real-facts-front', MD_REAL_FACTS_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'md-real-facts', MD_REAL_FACTS_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
