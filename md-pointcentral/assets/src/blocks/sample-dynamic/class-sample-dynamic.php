<?php
/**
 * Registers the md-pointcentral/sample-dynamic block.
 *
...
/**
 *  Class for the md-pointcentral/sample-dynamic block.
 */
class Sample_Dynamic extends Block_Base {
	...
	protected function setup_hooks() {
		add_filter( 'md_pointcentral_gutenberg_blocks_config', array( $this, 'localize_block_data' ) );
	}
