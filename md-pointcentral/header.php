...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'md-pointcentral' ); ?></a>

	<header id="masthead" class="md-pointcentral-header site-header u-bg-white">
		<div class="container">
			<div class="u-flex-columns u-align-items-center u-justify-content-space-between">
				...
				<div class="u-flex-column u-flex-basis-70 u-flex-basis-40@max-767">
					<nav id="site-navigation" class="main-navigation">
						...
						<div class="md-pointcentral-menu">
							<?php
								wp_nav_menu(
									array(
