 ...
 * @subpackage MD_Sync_Blog/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-sync-blog-front', MD_SYNC_BLOG_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-sync-blog', MD_SYNC_BLOG_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
