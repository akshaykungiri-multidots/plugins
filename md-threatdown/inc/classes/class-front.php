 ...
 * @subpackage MD_Threatdown/public
...
class Front {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'md-threatdown-front', MD_THREATDOWN_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-threatdown', MD_THREATDOWN_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
