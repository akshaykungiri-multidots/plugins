 ...
 * @since 1.0.0
 */
class Fiery_Hero_Subscribe extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Hero Subscribe', 'md-fiery-addon' );
	}
	...
	public function get_keywords() {
		return [ 'hero', 'news', 'subscribe', 'hero-subscribe' ];
	}
	...
	protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .fiery-hero-subscribe-heading',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333',
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-heading' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .fiery-hero-subscribe-content',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333',
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-content' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .fiery-hero-subscribe-button',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333',
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-button' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333',
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333',
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-button:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .fiery-hero-subscribe-button:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
	...
	protected function render() {
        ...
        <div class="fiery-hero-subscribe">
            <div class="fiery-hero-subscribe-content">
                <h2 class="fiery-hero-subscribe-heading"><?php echo esc_html( $settings['heading'] ); ?></h2>
                <p class="fiery-hero-subscribe-content"><?php echo esc_html( $settings['content'] ); ?></p>
                <a href="<?php echo esc_url( $settings['button_link']['url'] ); ?>" class="fiery-hero-subscribe-button"><?php echo esc_html( $settings['button_text'] ); ?></a>
            </div>
        </div>
	...
	protected function content_template() {
        ...
        <div class="fiery-hero-subscribe">
            <div class="fiery-hero-subscribe-content">
                <h2 class="fiery-hero-subscribe-heading">{{{ settings.heading }}}</h2>
                <p class="fiery-hero-subscribe-content">{{{ settings.content }}}</p>
                <a href="{{ settings.button_link.url }}" class="fiery-hero-subscribe-button">{{{ settings.button_text }}}</a>
            </div>
        </div>
        <?php
	}
