 ...
 * @subpackage MD_Fiery_Addon/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-fiery-addon-front', MD_FIERY_ADDON_URL . 'assets/build/main.css', array(), $this->version, 'all' );
		wp_enqueue_style( 'slick', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css' );
		// insert font awesome 5 free css.
		wp_enqueue_style( 'font-awesome-5', 'https://use.fontawesome.com/releases/v5.15.1/css/all.css' );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'md-fiery-addon', MD_FIERY_ADDON_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
