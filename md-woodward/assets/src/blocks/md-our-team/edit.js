...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_our_team" })}>
      <InspectorControls>
              ...
              gradients={[
                {
                  name: "Gradient 1",
                  gradient:
                    "linear-gradient(to right, #252a5b 0%, #005494 34%, #428ac4 100%)",
                },
                {
                  name: "Gradient 2",
                  gradient:
                    "linear-gradient(to right, #c73727 0%, #e76a24 100%)",
                },
                {
                  name: "Gradient 3",
        ...
        <PanelBody title={__("Toggle Settings")} initialOpen={false}>
          ...
          />
          <ToggleControl
            label={__("Show Banner Link")}
            checked={showBannerLink}
            onChange={() => setAttributes({ showBannerLink: !showBannerLink })}
          />
        </PanelBody>
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                onChange: (newColor) =>
                  setAttributes({ bannerLinkColor: newColor }),
                label: __("Banner Link Color"),
              },
            ]}
          />
        </PanelBody>
            ...
            <div className="md-our-team-button_wrapper">
              ...
              {showBannerLink && (
                <RichText
                  tagName="p"
                  value={bannerLink}
                  onChange={(value) => setAttributes({ bannerLink: value })}
