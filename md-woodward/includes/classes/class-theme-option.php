...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-woodward', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-woodward-theme-options">
				<div class="md-woodward-theme-options-header">
					<h1>MD Woodward Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-woodward&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-woodward' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-woodward-setting' );
					do_settings_sections( 'md-woodward' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-woodward-setting', 'md_woodward_settings' );
		add_settings_section( 'md-woodward-section', __( 'General Settings', 'md-woodward' ), '__return_empty_string', 'md-woodward' );
		add_settings_field(
			'md_woodward_logo',
			__( 'Site Logo:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'file',
				'name'  => 'md_woodward_settings[md_woodward_img]',
				'value' => 'md_woodward_img',
			)
		);
		add_settings_field(
			'md_woodward_favicon',
			__( 'Site Favicon:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'file',
				'name'  => 'md_woodward_settings[md_woodward_favicon]',
				'value' => 'md_woodward_favicon',
			)
		);
		add_settings_field(
			'md_woodward_tagline',
			__( 'Site Tagline:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'text',
				'name'  => 'md_woodward_settings[md_woodward_tagline]',
				'value' => 'md_woodward_tagline',
			)
		);
		add_settings_field(
			'md_woodward_google_analytic',
			__( 'Google Analytic:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_woodward_settings[md_woodward_google_analytic]',
				'value' => 'md_woodward_google_analytic',
			)
		);
		add_settings_field(
			'md_woodward_css_code',
			__( 'Additional CSS:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_woodward_settings[md_woodward_css_code]',
				'value' => 'md_woodward_css_code',
			)
		);
		add_settings_field(
			'md_woodward_html_code',
			__( 'Additional html:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_woodward_settings[md_woodward_html_code]',
				'value' => 'md_woodward_html_code',
			)
		);
		add_settings_field(
			'md_woodward_color_picker',
			__( 'Color:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_woodward_settings[md_woodward_color_picker]',
				'value' => 'md_woodward_color_picker',
			)
		);
		add_settings_field(
			'md_woodward_wysiwyg',
			__( 'Text Editor:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_woodward_settings[md_woodward_wysiwyg]',
				'value' => 'md_woodward_wysiwyg',
			)
		);
		add_settings_field(
			'md_woodward_password',
			__( 'Manage Password:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'password',
				'name'  => 'md_woodward_settings[md_woodward_password]',
				'id'    => 'password',
				'value' => 'md_woodward_password',
			)
		);
		add_settings_field(
			'md_woodward_selectbox',
			__( 'Select Option:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'    => 'select',
				'name'    => 'md_woodward_settings[md_woodward_selectbox]',
				'value'   => 'md_woodward_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_woodward_multiselect',
			__( 'Select Multiple Option:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_woodward_settings[md_woodward_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_woodward_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_woodward_radio',
			__( 'Select Radio Option:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_woodward_settings[md_woodward_radio]',
				'value'   => 'md_woodward_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_woodward_checkbox',
			__( 'Select Checkbox Option:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_woodward_settings[md_woodward_checkbox]',
				'value' => 'md_woodward_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_woodward_number',
			__( 'Number:', 'md-woodward' ),
			array( $this, 'add_field' ),
			'md-woodward',
			'md-woodward-section',
			array(
				'type'  => 'number',
				'name'  => 'md_woodward_settings[md_woodward_number]',
				'value' => 'md_woodward_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_woodward_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_woodward_img" 
			...
			?>
		/>
		<input class="md_woodward_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_woodward_img_upload"><button>Upload</button></a>
		<a href="#" class="md_woodward_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_WOODWARD_BUILD_URI . '/themeoption.css', array(), filemtime( MD_WOODWARD_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_WOODWARD_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_WOODWARD_BUILD_PATH . '/themeoption.js' ), true );
