...
class Register_Taxonomies {
	...
	public function register_event_category_taxonomy() {
		...
		$labels = array(
			'name'              => _x( 'Event Categories', 'taxonomy general name', 'md-fiery' ),
			'singular_name'     => _x( 'Event Category', 'taxonomy singular name', 'md-fiery' ),
			'search_items'      => __( 'Search Event Categories', 'md-fiery' ),
			'all_items'         => __( 'All Event Categories', 'md-fiery' ),
			'parent_item'       => __( 'Parent Event Category', 'md-fiery' ),
			'parent_item_colon' => __( 'Parent Event Category:', 'md-fiery' ),
			'edit_item'         => __( 'Edit Event Category', 'md-fiery' ),
			'update_item'       => __( 'Update Event Category', 'md-fiery' ),
			'add_new_item'      => __( 'Add New Event Category', 'md-fiery' ),
			'new_item_name'     => __( 'New Event Category Name', 'md-fiery' ),
			'menu_name'         => __( 'Event Category', 'md-fiery' ),
		);
		$args   = array(
			'labels'             => $labels,
			'description'        => __( 'Event Category', 'md-fiery' ),
			'hierarchical'       => true,
			'public'             => true,
		...
		// Brands.
		$labels = array(
			'name'              => _x( 'Brands', 'taxonomy general name', 'md-fiery' ),
			'singular_name'     => _x( 'Brand', 'taxonomy singular name', 'md-fiery' ),
			'search_items'      => __( 'Search Brands', 'md-fiery' ),
			'all_items'         => __( 'All Brands', 'md-fiery' ),
			'parent_item'       => __( 'Parent Brand', 'md-fiery' ),
			'parent_item_colon' => __( 'Parent Brand:', 'md-fiery' ),
			'edit_item'         => __( 'Edit Brand', 'md-fiery' ),
			'update_item'       => __( 'Update Brand', 'md-fiery' ),
			'add_new_item'      => __( 'Add New Brand', 'md-fiery' ),
			'new_item_name'     => __( 'New Brand Name', 'md-fiery' ),
			'menu_name'         => __( 'Brands', 'md-fiery' ),
		);
		$args   = array(
			'labels'             => $labels,
			'description'        => __( 'Brands', 'md-fiery' ),
			'hierarchical'       => true,
			'public'             => true,
			'publicly_queryable' => true,
			'show_ui'            => true,
	...
	public function add_brand_fields() {
		...
		<tr class="form-field">
			<th scope="row" valign="top">
				<label for="brand-image-id"><?php esc_html_e( 'Brand Image', 'md-fiery' ); ?></label>
			</th>
			<td>
				...
				<button id="ct_tax_media_button" class="button"><?php esc_html_e( 'Add Image', 'md-fiery' ); ?></button>
				<button id="ct_tax_media_remove" class="button"><?php esc_html_e( 'Remove Image', 'md-fiery' ); ?></button>
			</td>
		</tr>
		<?php
		echo '<script>
