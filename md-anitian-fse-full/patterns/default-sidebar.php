...
/**
 * Title: Sidebar
 * Slug: md-anitian-fse-full/default-sidebar
 * Categories: sidebar
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Categorise', 'md-anitian-fse-full' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Tags', 'md-anitian-fse-full' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
