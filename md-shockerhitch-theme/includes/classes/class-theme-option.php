...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-shockerhitch', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-shockerhitch-theme-options">
				<div class="md-shockerhitch-theme-options-header">
					<h1>MD Shockerhitch Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-shockerhitch&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-shockerhitch' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-shockerhitch-setting' );
					do_settings_sections( 'md-shockerhitch' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-shockerhitch-setting', 'md_shockerhitch_settings' );
		add_settings_section( 'md-shockerhitch-section', __( 'General Settings', 'md-shockerhitch' ), '__return_empty_string', 'md-shockerhitch' );
		add_settings_field(
			'md_shockerhitch_logo',
			__( 'Site Logo:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'file',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_img]',
				'value' => 'md_shockerhitch_img',
			)
		);
		add_settings_field(
			'md_shockerhitch_favicon',
			__( 'Site Favicon:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'file',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_favicon]',
				'value' => 'md_shockerhitch_favicon',
			)
		);
		add_settings_field(
			'md_shockerhitch_tagline',
			__( 'Site Tagline:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'text',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_tagline]',
				'value' => 'md_shockerhitch_tagline',
			)
		);
		add_settings_field(
			'md_shockerhitch_google_analytic',
			__( 'Google Analytic:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_google_analytic]',
				'value' => 'md_shockerhitch_google_analytic',
			)
		);
		add_settings_field(
			'md_shockerhitch_css_code',
			__( 'Additional CSS:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_css_code]',
				'value' => 'md_shockerhitch_css_code',
			)
		);
		add_settings_field(
			'md_shockerhitch_html_code',
			__( 'Additional html:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_html_code]',
				'value' => 'md_shockerhitch_html_code',
			)
		);
		add_settings_field(
			'md_shockerhitch_color_picker',
			__( 'Color:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_color_picker]',
				'value' => 'md_shockerhitch_color_picker',
			)
		);
		add_settings_field(
			'md_shockerhitch_wysiwyg',
			__( 'Text Editor:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_wysiwyg]',
				'value' => 'md_shockerhitch_wysiwyg',
			)
		);
		add_settings_field(
			'md_shockerhitch_password',
			__( 'Manage Password:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'password',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_password]',
				'id'    => 'password',
				'value' => 'md_shockerhitch_password',
			)
		);
		add_settings_field(
			'md_shockerhitch_selectbox',
			__( 'Select Option:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'    => 'select',
				'name'    => 'md_shockerhitch_settings[md_shockerhitch_selectbox]',
				'value'   => 'md_shockerhitch_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_shockerhitch_multiselect',
			__( 'Select Multiple Option:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_shockerhitch_settings[md_shockerhitch_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_shockerhitch_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_shockerhitch_radio',
			__( 'Select Radio Option:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_shockerhitch_settings[md_shockerhitch_radio]',
				'value'   => 'md_shockerhitch_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_shockerhitch_checkbox',
			__( 'Select Checkbox Option:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_checkbox]',
				'value' => 'md_shockerhitch_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_shockerhitch_number',
			__( 'Number:', 'md-shockerhitch' ),
			array( $this, 'add_field' ),
			'md-shockerhitch',
			'md-shockerhitch-section',
			array(
				'type'  => 'number',
				'name'  => 'md_shockerhitch_settings[md_shockerhitch_number]',
				'value' => 'md_shockerhitch_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_shockerhitch_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_shockerhitch_img" 
			...
			?>
		/>
		<input class="md_shockerhitch_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_shockerhitch_img_upload"><button>Upload</button></a>
		<a href="#" class="md_shockerhitch_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_SHOCKERHITCH_BUILD_URI . '/themeoption.css', array(), filemtime( MD_SHOCKERHITCH_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_SHOCKERHITCH_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_SHOCKERHITCH_BUILD_PATH . '/themeoption.js' ), true );
