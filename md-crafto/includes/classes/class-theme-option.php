...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-crafto', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-crafto-theme-options">
				<div class="md-crafto-theme-options-header">
					<h1>MD Crafto Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-crafto&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-crafto' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-crafto-setting' );
					do_settings_sections( 'md-crafto' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-crafto-setting', 'md_crafto_settings' );
		add_settings_section( 'md-crafto-section', __( 'General Settings', 'md-crafto' ), '__return_empty_string', 'md-crafto' );
		add_settings_field(
			'md_crafto_logo',
			__( 'Site Logo:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'file',
				'name'  => 'md_crafto_settings[md_crafto_img]',
				'value' => 'md_crafto_img',
			)
		);
		add_settings_field(
			'md_crafto_favicon',
			__( 'Site Favicon:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'file',
				'name'  => 'md_crafto_settings[md_crafto_favicon]',
				'value' => 'md_crafto_favicon',
			)
		);
		add_settings_field(
			'md_crafto_tagline',
			__( 'Site Tagline:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'text',
				'name'  => 'md_crafto_settings[md_crafto_tagline]',
				'value' => 'md_crafto_tagline',
			)
		);
		add_settings_field(
			'md_crafto_google_analytic',
			__( 'Google Analytic:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_crafto_settings[md_crafto_google_analytic]',
				'value' => 'md_crafto_google_analytic',
			)
		);
		add_settings_field(
			'md_crafto_css_code',
			__( 'Additional CSS:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_crafto_settings[md_crafto_css_code]',
				'value' => 'md_crafto_css_code',
			)
		);
		add_settings_field(
			'md_crafto_html_code',
			__( 'Additional html:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_crafto_settings[md_crafto_html_code]',
				'value' => 'md_crafto_html_code',
			)
		);
		add_settings_field(
			'md_crafto_color_picker',
			__( 'Color:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_crafto_settings[md_crafto_color_picker]',
				'value' => 'md_crafto_color_picker',
			)
		);
		add_settings_field(
			'md_crafto_wysiwyg',
			__( 'Text Editor:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_crafto_settings[md_crafto_wysiwyg]',
				'value' => 'md_crafto_wysiwyg',
			)
		);
		add_settings_field(
			'md_crafto_password',
			__( 'Manage Password:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'password',
				'name'  => 'md_crafto_settings[md_crafto_password]',
				'id'    => 'password',
				'value' => 'md_crafto_password',
			)
		);
		add_settings_field(
			'md_crafto_selectbox',
			__( 'Select Option:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'    => 'select',
				'name'    => 'md_crafto_settings[md_crafto_selectbox]',
				'value'   => 'md_crafto_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_crafto_multiselect',
			__( 'Select Multiple Option:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_crafto_settings[md_crafto_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_crafto_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_crafto_radio',
			__( 'Select Radio Option:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_crafto_settings[md_crafto_radio]',
				'value'   => 'md_crafto_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_crafto_checkbox',
			__( 'Select Checkbox Option:', 'md-crafto' ),
			array( $this, 'add_field' ),
			'md-crafto',
			'md-crafto-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_crafto_settings[md_crafto_checkbox]',
				'value' => 'md_crafto_checkbox',
		...
		add_settings_field(
			...
			array(
				'type'  => 'number',
				'name'  => 'md_crafto_settings[md_crafto_number]',
				'value' => 'md_crafto_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_crafto_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_crafto_img" 
			...
			?>
		/>
		<input class="md_crafto_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_crafto_img_upload"><button>Upload</button></a>
		<a href="#" class="md_crafto_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_CRAFTO_BUILD_URI . '/themeoption.css', array(), filemtime( MD_CRAFTO_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_CRAFTO_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_CRAFTO_BUILD_PATH . '/themeoption.js' ), true );
