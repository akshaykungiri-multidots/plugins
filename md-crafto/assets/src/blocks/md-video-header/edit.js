...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_crafto_video_header_section" })}>
      <InspectorControls>
        <PanelBody title={__("Video Settings", "md-crafto")} initialOpen={true}>
        ...
        <PanelBody title={__("Text Settings", "md-crafto")} initialOpen={false}>
          ...
          <Button
            ...
            className="components-button button button-large"
          >
            {__("Add Text", "md-crafto")}
          </Button>
        </PanelBody>
        <PanelBody
          title={__("Background Settings", "md-crafto")}
          initialOpen={false}
        >
        ...
        <PanelBody
          title={__("Toggle Settings", "md-crafto")}
          initialOpen={false}
        >
          <ToggleControl
          ...
          />
          <ToggleControl
            label={__("Show Video Footer Text", "md-crafto")}
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                label: __("Video Footer Text Color", "md-crafto"),
              },
            ]}
          />
        </PanelBody>
      </InspectorControls>
      <div className="md_crafto_text_video_wrap" style={{ backgroundImage: `url(${backgroundImage})` }}>
        <div
          className="md_crafto_text_video"
          style={{
            background: `${backgroundColor}`,
          }}
        >
          <div
            className="md_crafto_text_video__inner"
          >
            <div className="md_crafto_text_video__heading">
              <h3
                className="md_crafto_text_video__typing_title"
              ...
              >
                ...
                <span
                  className="md_crafto_text_video__typing"
          ...
          <div className="md_crafto_text_video__footer">
            {showVideoFooterText && (
              <RichText
                tagName="p"
                ...
                placeholder={__("Enter Footer Text", "md-crafto")}
