...
export default function Edit({ attributes, setAttributes, className }) {
  ...
  useEffect(() => {
    wp.apiFetch({ path: "md-crafto/v1/service-posts" }).then((data) => {
      setServiceData(data);
    });
  }, []);
    ...
    <div {...useBlockProps()}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-crafto")}>
          <ToggleControl
            label={__("Show Heading", "md-crafto")}
            checked={showHeading}
            onChange={(value) => setAttributes({ showHeading: value })}
          />
          <ToggleControl
            label={__("Show Sub Heading", "md-crafto")}
            checked={showSubHeading}
            onChange={(value) => setAttributes({ showSubHeading: value })}
          />
          <ToggleControl
            label={__("Show Content", "md-crafto")}
            checked={showContent}
            onChange={(value) => setAttributes({ showContent: value })}
          />
          <ToggleControl
            label={__("Show Footer", "md-crafto")}
            checked={showFooter}
            ...
            colorSettings={[
              {
                ...
                label: __("Sub Heading Color", "md-crafto"),
              },
              {
                value: headingColor,
                onChange: (colorValue) =>
                  setAttributes({ headingColor: colorValue }),
                label: __("Heading Color", "md-crafto"),
              },
              {
                value: contentColor,
                onChange: (colorValue) =>
          ...
          <div className="service-slider__content">
            <div className="service-slider__heading_wrapper">
              {showSubHeading && (
                <RichText
                  ...
                  placeholder={__("Sub Heading", "md-crafto")}
              ...
              {showHeading && (
                <RichText
                  ...
                  placeholder={__("Heading", "md-crafto")}
            ...
            {showContent && (
              <RichText
                ...
                placeholder={__("Content", "md-crafto")}
        ...
        {showFooter && (
          <div className="service-slider__footer">
            ...
            <RichText
              ...
              placeholder={__("Footer Text", "md-crafto")}
