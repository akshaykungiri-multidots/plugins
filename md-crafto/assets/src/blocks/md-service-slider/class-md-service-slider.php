...
/**
 * Registers the md-crafto/md-service-slider block.
 *
...
/**
 *  Class for the md-crafto/md-service-slider block.
 */
class MD_Service_Slider extends Block_Base
{
  ...
  public function render_callback(
    ...
    $serviceSubTitleColor = isset($attributes['serviceSubTitleColor']) ? $attributes['serviceSubTitleColor'] : '';
              ...
              ?>
                  <div class="service-slider__slide">
                    ...
                    <div class="service-slider__slide-content">
                      <?php if ($service_icon) : ?>
                        <div class="service-slider__slide-icon">
                      ...
                      <div class="service-slider__slide-text">
                        ...
                        <div class="service-slider__slide-readmore__wrapper">
                          <?php if ($service_subtitle) : ?>
                            <p class="service-slider__slide-subtitle" style="color: <?php echo esc_attr($serviceSubTitleColor); ?>"><?php echo esc_html($service_subtitle); ?></p>
                          <?php endif; ?>
