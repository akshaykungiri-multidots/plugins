...
/***/ "./src/blocks/md-number-text/edit.js":
/*!*******************************************!*\
  !*** ./src/blocks/md-number-text/edit.js ***!
  \*******************************************/
...
function Edit({
  ...
  const displayStarRating = title => {
    ...
    for (let i = 0; i < title; i++) {
      starRating.push((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        key: i,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Settings", "md-prime"),
    initialOpen: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Columns", "md-prime"),
    value: columns,
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Enable Border", "md-prime"),
    checked: enableBorder,
    onChange: value => setAttributes({
      enableBorder: value
    })
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Color Settings", "md-crafto-fse-full"),
    initialOpen: false
    ...
    colorSettings: [{
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Column Description Font Color")
          ...
          .crafto-stat-number__inner__item:last-child {
            border-right: none !important;
          }
        `), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `crafto-stat-number ${enableBorder ? "none" : "top"}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "crafto-stat-number__inner",
    style: {
      backgroundColor
    }
  }, columnList && columnList.map((postObj, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "crafto-stat-number__inner__item fadeInUp show-items-hover-wrap",
    key: index,
    style: {
      width: `${100 / columns}%`,
      borderColor
  ...
  }, postObj.enableStar && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "review-star-rating"
  }, displayStarRating(postObj.title)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "p",
    style: {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Enable Star", "md-prime"),
    checked: postObj.enableStar,
    onChange: value => updateStaticPostObj(index, "enableStar", value)
  }))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/***/ "./src/blocks/md-number-text/index.js":
/*!********************************************!*\
  !*** ./src/blocks/md-number-text/index.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/md-number-text/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/md-number-text/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/md-number-text/block.json");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/md-number-text/style.scss");
/**
...
/***/ "./src/blocks/md-number-text/save.js":
/*!*******************************************!*\
  !*** ./src/blocks/md-number-text/save.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function save({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "review-star-rating"
  }, displayStarRating(postObj.title)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "p",
    style: {
      color: columnDescriptionFontColor
    },
...
/***/ "./src/blocks/md-number-text/style.scss":
/*!**********************************************!*\
  !*** ./src/blocks/md-number-text/style.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/md-number-text/block.json":
/*!**********************************************!*\
  !*** ./src/blocks/md-number-text/block.json ***!
  \**********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","name":"md-crafto/md-number-text","version":"0.1.0","title":"MD Number Text","apiVersion":3,"category":"md-crafto","icon":"images-alt","description":"A block to display a number with a text.","keywords":["md-crafto","md-number-text"],"supports":{"html":false},"textdomain":"md-crafto","attributes":{"columnList":{"type":"array","default":[{"id":1,"title":"","description":""}]},"columnTitleFontColor":{"type":"string","default":""},"columnDescriptionFontColor":{"type":"string","default":""},"borderColor":{"type":"string","default":""},"backgroundColor":{"type":"string","default":""},"columns":{"type":"number","default":3},"enableBorder":{"type":"boolean","default":false}},"editorScript":"file:./index.js","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/md-number-text/index": 0,
/******/ 			"blocks/md-number-text/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/md-number-text/style-index"], () => (__webpack_require__("./src/blocks/md-number-text/index.js")))
