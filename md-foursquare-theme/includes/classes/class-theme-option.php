...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-foursquare', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-foursquare-theme-options">
				<div class="md-foursquare-theme-options-header">
					<h1>MD Foursquare Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-foursquare&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-foursquare' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-foursquare-setting' );
					do_settings_sections( 'md-foursquare' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-foursquare-setting', 'md_foursquare_settings' );
		add_settings_section( 'md-foursquare-section', __( 'General Settings', 'md-foursquare' ), '__return_empty_string', 'md-foursquare' );
		add_settings_field(
			'md_foursquare_logo',
			__( 'Site Logo:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'file',
				'name'  => 'md_foursquare_settings[md_foursquare_img]',
				'value' => 'md_foursquare_img',
			)
		);
		add_settings_field(
			'md_foursquare_favicon',
			__( 'Site Favicon:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'file',
				'name'  => 'md_foursquare_settings[md_foursquare_favicon]',
				'value' => 'md_foursquare_favicon',
			)
		);
		add_settings_field(
			'md_foursquare_tagline',
			__( 'Site Tagline:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'text',
				'name'  => 'md_foursquare_settings[md_foursquare_tagline]',
				'value' => 'md_foursquare_tagline',
			)
		);
		add_settings_field(
			'md_foursquare_google_analytic',
			__( 'Google Analytic:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_foursquare_settings[md_foursquare_google_analytic]',
				'value' => 'md_foursquare_google_analytic',
			)
		);
		add_settings_field(
			'md_foursquare_css_code',
			__( 'Additional CSS:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_foursquare_settings[md_foursquare_css_code]',
				'value' => 'md_foursquare_css_code',
			)
		);
		add_settings_field(
			'md_foursquare_html_code',
			__( 'Additional html:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_foursquare_settings[md_foursquare_html_code]',
				'value' => 'md_foursquare_html_code',
			)
		);
		add_settings_field(
			'md_foursquare_color_picker',
			__( 'Color:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_foursquare_settings[md_foursquare_color_picker]',
				'value' => 'md_foursquare_color_picker',
			)
		);
		add_settings_field(
			'md_foursquare_wysiwyg',
			__( 'Text Editor:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_foursquare_settings[md_foursquare_wysiwyg]',
				'value' => 'md_foursquare_wysiwyg',
			)
		);
		add_settings_field(
			'md_foursquare_password',
			__( 'Manage Password:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'password',
				'name'  => 'md_foursquare_settings[md_foursquare_password]',
				'id'    => 'password',
				'value' => 'md_foursquare_password',
			)
		);
		add_settings_field(
			'md_foursquare_selectbox',
			__( 'Select Option:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'    => 'select',
				'name'    => 'md_foursquare_settings[md_foursquare_selectbox]',
				'value'   => 'md_foursquare_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_foursquare_multiselect',
			__( 'Select Multiple Option:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_foursquare_settings[md_foursquare_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_foursquare_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_foursquare_radio',
			__( 'Select Radio Option:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_foursquare_settings[md_foursquare_radio]',
				'value'   => 'md_foursquare_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_foursquare_checkbox',
			__( 'Select Checkbox Option:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_foursquare_settings[md_foursquare_checkbox]',
				'value' => 'md_foursquare_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_foursquare_number',
			__( 'Number:', 'md-foursquare' ),
			array( $this, 'add_field' ),
			'md-foursquare',
			'md-foursquare-section',
			array(
				'type'  => 'number',
				'name'  => 'md_foursquare_settings[md_foursquare_number]',
				'value' => 'md_foursquare_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_foursquare_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_foursquare_img" 
			...
			?>
		/>
		<input class="md_foursquare_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_foursquare_img_upload"><button>Upload</button></a>
		<a href="#" class="md_foursquare_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_FOURSQUARE_BUILD_URI . '/themeoption.css', array(), filemtime( MD_FOURSQUARE_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_FOURSQUARE_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_FOURSQUARE_BUILD_PATH . '/themeoption.js' ), true );
