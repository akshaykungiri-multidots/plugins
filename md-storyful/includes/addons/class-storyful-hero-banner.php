<?php
/**
 * The Storyful Hero Banner functionality of the plugin.
 *
 * @package    MD_STORYFUL
...
/**
 * Storyful_Hero_Banner class
 * 
 * @since 1.0.0
 */
class Storyful_Hero_Banner {

    // Create Storyful Hero Banner Custom Elements for Bakery.
    ...
    public function __construct() {
        add_action('vc_before_init', array($this, 'storyful_hero_banner'));
        add_shortcode('storyful_hero_banner', array($this, 'storyful_hero_banner_html'));
    }

    /**
     * Function is used to create Storyful Hero Banner custom element.
     */
    public function storyful_hero_banner() {

        // Storyful Hero Banner.
        vc_map(array(
            'name' => __('Storyful Hero Banner', 'md-bakery-antian'),
            'base' => 'storyful_hero_banner',
            'params' => array(
                // Title
                array(
                    'type' => 'textfield',
                ...
                array(
                    ...
                    'param_name' => 'media_banner_image',
                    'value' => '',
                    'description' => __('Add banner image.', 'md-bakery-antian'),
                ),
                // Banner Content Text
                array(
                    'type' => 'textarea',
                    'heading' => __('Banner Content Text', 'md-bakery-antian'),
                    'param_name' => 'banner_content_text',
                    'value' => '',
                    'description' => __('Enter banner content text.', 'md-bakery-antian'),
                ),
                // Banner Button Link
                array(
                    'type' => 'vc_link',
    ...
    /**
     * Function is used to display Storyful Hero Banner html.
     */
    public function storyful_hero_banner_html($atts) {
        ...
        $media_banner_image = (isset($atts['media_banner_image']) && !empty($atts['media_banner_image'])) ? wp_get_attachment_url($atts['media_banner_image']) : '';
        ob_start();
        ?>
            ...
            <div class="container">
                <div class="md_storyful_storyful_hero_banner__inner">
                    ...
                    <div class="md_storyful_storyful_hero_banner__content">
                        <?php if (!empty($media_banner_image)) { ?>
                            <div class="md_storyful_storyful_hero_banner__content__image">
                                <img src="<?php echo esc_url($media_banner_image); ?>" alt="<?php echo esc_attr($atts['title']); ?>">
                            </div>
                        <?php } ?>
                        <div class="md_storyful_storyful_hero_banner__content__text">
                            <h3><?php echo wp_kses_post($atts['banner_content_text']); ?></h3>
                            <div class="md_storyful_storyful_hero_banner__content__button btn btn-arrow btn-secondary">
                                <?php
