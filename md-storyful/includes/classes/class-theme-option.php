...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-storyful', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-storyful-theme-options">
				<div class="md-storyful-theme-options-header">
					<h1>MD Storyful Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-storyful&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-storyful' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-storyful-setting' );
					do_settings_sections( 'md-storyful' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-storyful-setting', 'md_storyful_settings' );
		add_settings_section( 'md-storyful-section', __( 'General Settings', 'md-storyful' ), '__return_empty_string', 'md-storyful' );
		add_settings_field(
			'md_storyful_logo',
			__( 'Site Logo:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'file',
				'name'  => 'md_storyful_settings[md_storyful_img]',
				'value' => 'md_storyful_img',
			)
		);
		add_settings_field(
			'md_storyful_favicon',
			__( 'Site Favicon:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'file',
				'name'  => 'md_storyful_settings[md_storyful_favicon]',
				'value' => 'md_storyful_favicon',
			)
		);
		add_settings_field(
			'md_storyful_tagline',
			__( 'Site Tagline:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'text',
				'name'  => 'md_storyful_settings[md_storyful_tagline]',
				'value' => 'md_storyful_tagline',
			)
		);
		add_settings_field(
			'md_storyful_google_analytic',
			__( 'Google Analytic:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_storyful_settings[md_storyful_google_analytic]',
				'value' => 'md_storyful_google_analytic',
			)
		);
		add_settings_field(
			'md_storyful_css_code',
			__( 'Additional CSS:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_storyful_settings[md_storyful_css_code]',
				'value' => 'md_storyful_css_code',
			)
		);
		add_settings_field(
			'md_storyful_html_code',
			__( 'Additional html:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_storyful_settings[md_storyful_html_code]',
				'value' => 'md_storyful_html_code',
			)
		);
		add_settings_field(
			'md_storyful_color_picker',
			__( 'Color:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_storyful_settings[md_storyful_color_picker]',
				'value' => 'md_storyful_color_picker',
			)
		);
		add_settings_field(
			'md_storyful_wysiwyg',
			__( 'Text Editor:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_storyful_settings[md_storyful_wysiwyg]',
				'value' => 'md_storyful_wysiwyg',
			)
		);
		add_settings_field(
			'md_storyful_password',
			__( 'Manage Password:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'password',
				'name'  => 'md_storyful_settings[md_storyful_password]',
				'id'    => 'password',
				'value' => 'md_storyful_password',
			)
		);
		add_settings_field(
			'md_storyful_selectbox',
			__( 'Select Option:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'    => 'select',
				'name'    => 'md_storyful_settings[md_storyful_selectbox]',
				'value'   => 'md_storyful_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_storyful_multiselect',
			__( 'Select Multiple Option:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_storyful_settings[md_storyful_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_storyful_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_storyful_radio',
			__( 'Select Radio Option:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_storyful_settings[md_storyful_radio]',
				'value'   => 'md_storyful_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_storyful_checkbox',
			__( 'Select Checkbox Option:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_storyful_settings[md_storyful_checkbox]',
				'value' => 'md_storyful_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_storyful_number',
			__( 'Number:', 'md-storyful' ),
			array( $this, 'add_field' ),
			'md-storyful',
			'md-storyful-section',
			array(
				'type'  => 'number',
				'name'  => 'md_storyful_settings[md_storyful_number]',
				'value' => 'md_storyful_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_storyful_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_storyful_img" 
			...
			?>
		/>
		<input class="md_storyful_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_storyful_img_upload"><button>Upload</button></a>
		<a href="#" class="md_storyful_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_STORYFUL_BUILD_URI . '/themeoption.css', array(), filemtime( MD_STORYFUL_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_STORYFUL_BUILD_URI . '/themeoption.js', array( 'jquery', 'wp-color-picker' ), filemtime( MD_STORYFUL_BUILD_PATH . '/themeoption.js' ), true );
