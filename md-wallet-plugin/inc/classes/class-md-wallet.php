 ...
 * @since      1.0.0
 * @package    MD_Wallet
 * @subpackage MD_Wallet/includes
 * @author     Multidots <info@multidots.com>
 */

namespace MD_Wallet\Inc;

use MD_Wallet\Inc\Blocks;
...
class MD_Wallet {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      MD_Wallet_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
