 ...
 * @subpackage MD_Sync_Post_Multisite/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-sync-post-multisite-front', MD_SYNC_POST_MULTISITE_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-sync-post-multisite', MD_SYNC_POST_MULTISITE_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
