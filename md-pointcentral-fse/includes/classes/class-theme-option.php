...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-pointcentral-fse', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-pointcentral-fse-theme-options">
				<div class="md-pointcentral-fse-theme-options-header">
					<h1>MD Pointcentral Fse Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-pointcentral-fse&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-pointcentral-fse' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-pointcentral-fse-setting' );
					do_settings_sections( 'md-pointcentral-fse' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-pointcentral-fse-setting', 'md_pointcentral_fse_settings' );
		add_settings_section( 'md-pointcentral-fse-section', __( 'General Settings', 'md-pointcentral-fse' ), '__return_empty_string', 'md-pointcentral-fse' );
		add_settings_field(
			'md_pointcentral_fse_logo',
			__( 'Site Logo:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'file',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_img]',
				'value' => 'md_pointcentral_fse_img',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_favicon',
			__( 'Site Favicon:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'file',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_favicon]',
				'value' => 'md_pointcentral_fse_favicon',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_tagline',
			__( 'Site Tagline:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'text',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_tagline]',
				'value' => 'md_pointcentral_fse_tagline',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_google_analytic',
			__( 'Google Analytic:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_google_analytic]',
				'value' => 'md_pointcentral_fse_google_analytic',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_css_code',
			__( 'Additional CSS:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_css_code]',
				'value' => 'md_pointcentral_fse_css_code',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_html_code',
			__( 'Additional html:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_html_code]',
				'value' => 'md_pointcentral_fse_html_code',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_color_picker',
			__( 'Color:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_color_picker]',
				'value' => 'md_pointcentral_fse_color_picker',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_wysiwyg',
			__( 'Text Editor:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_wysiwyg]',
				'value' => 'md_pointcentral_fse_wysiwyg',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_password',
			__( 'Manage Password:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'password',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_password]',
				'id'    => 'password',
				'value' => 'md_pointcentral_fse_password',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_selectbox',
			__( 'Select Option:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'    => 'select',
				'name'    => 'md_pointcentral_fse_settings[md_pointcentral_fse_selectbox]',
				'value'   => 'md_pointcentral_fse_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_pointcentral_fse_multiselect',
			__( 'Select Multiple Option:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_pointcentral_fse_settings[md_pointcentral_fse_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_pointcentral_fse_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_pointcentral_fse_radio',
			__( 'Select Radio Option:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_pointcentral_fse_settings[md_pointcentral_fse_radio]',
				'value'   => 'md_pointcentral_fse_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_pointcentral_fse_checkbox',
			__( 'Select Checkbox Option:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_checkbox]',
				'value' => 'md_pointcentral_fse_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_pointcentral_fse_number',
			__( 'Number:', 'md-pointcentral-fse' ),
			array( $this, 'add_field' ),
			'md-pointcentral-fse',
			'md-pointcentral-fse-section',
			array(
				'type'  => 'number',
				'name'  => 'md_pointcentral_fse_settings[md_pointcentral_fse_number]',
				'value' => 'md_pointcentral_fse_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_pointcentral_fse_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		?>
		<img class="md_pointcentral_fse_img" 
			...
			?>
		/>
		<input class="md_pointcentral_fse_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_pointcentral_fse_img_upload"><button>Upload</button></a>
		<a href="#" class="md_pointcentral_fse_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_POINTCENTRAL_FSE_BUILD_URI . '/themeoption.css', array(), filemtime( MD_POINTCENTRAL_FSE_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_POINTCENTRAL_FSE_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_POINTCENTRAL_FSE_BUILD_PATH . '/themeoption.js' ), true );
