          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                onChange: (value) =>
                  setAttributes({ imageBoxBackgroundColor: value }),
                label: __("Image Box Background Color", "md-storyful-fse-full"),
              },
              {
                value: imageBoxTitleColor,
                onChange: (value) =>
                  setAttributes({ imageBoxTitleColor: value }),
                label: __("Image Box Title Color", "md-storyful-fse-full"),
              },
              {
              ...
              <div className="bakery_antian__slider md-slick-slider">
                {imageBoxes &&
                  imageBoxes.map((postObj, index) => (
                    <div className="bakery_antian__slider-item show-items-hover-wrap" key={index} style={{ backgroundColor: imageBoxBackgroundColor }}>
                      ...
                      <div className="bakery_antiab__slider-content">
                        <RichText
                          ...
                          onChange={(value) =>
                            updateStaticPostObj(index, "slider_title", value)
                          }
