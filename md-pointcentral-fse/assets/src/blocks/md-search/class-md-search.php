<?php
/**
 * Registers the md-pointcentral-fse/sample-dynamic block.
 *
...
/**
 *  Class for the md-pointcentral-fse/md-search block.
 */
class MD_Search extends Block_Base {
	...
	protected function setup_hooks() {
		add_filter( 'md_pointcentral_fse_gutenberg_blocks_config', array( $this, 'localize_block_data' ) );
	}
