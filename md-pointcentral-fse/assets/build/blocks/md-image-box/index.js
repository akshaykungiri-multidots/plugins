...
function Edit({
  ...
  const addStaticPostObj = () => {
    const staticPostObj = [...imageItems, {
      id: imageItems.length + 1,
      image: "",
      title: ""
    }];
    setAttributes({
      imageItems: staticPostObj
    });
  };
  const updateStaticPostObj = (index, key, value) => {
    ...
    setAttributes({
      imageItems: updatedStaticPostObj
    });
  };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
      className: "MD_Pointcentral_Image_Box"
    })
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Theme Style"),
    value: themeStyle,
    options: [{
      label: "Style 1",
      value: "style_1"
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Image Title"),
    checked: showImageTitle,
    onChange: value => setAttributes({
      showImageTitle: value
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Button"),
    checked: showButton,
    onChange: value => setAttributes({
      showButton: value
    })
    ...
    colorSettings: [{
      ...
      onChange: value => setAttributes({
        imageItemTitleColor: value
      }),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Image Title Color")
    }, {
      value: buttonColor,
      onChange: value => setAttributes({
        buttonColor: value
    ...
    className: `pointcentral-press-listing ${themeStyle}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "md_container"
  }, showHeading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pointcentral-press-listing__header"
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Title", "md-pointcentral-fse")
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pointcentral-press-listing__items"
  }, imageItems && imageItems.map((postObj, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pointcentral-press-listing__item show-items-hover-wrap",
    style: {
      width: `calc(100% / ${numberOfColumns} - 30px)`
    },
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  })), index + 1 < imageItems.length && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Tooltip, {
  ...
  }))), 1 < imageItems.length && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Tooltip, {
    ...
    onClick: () => {
      ...
      if (toDelete) {
        const updatedArray = imageItems.filter((item, itemIndex) => itemIndex !== index);
        setAttributes({
    ...
    alt: "slider"
  }))), showImageTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pointcentral-press-listing__item-title"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "div",
    className: "pointcentral-press-listing__item-link",
    style: {
      color: imageItemTitleColor
    },
    value: postObj.title,
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","name":"md-pointcentral-fse/md-image-box","version":"0.1.0","title":"MD Image Box","apiVersion":3,"category":"md-pointcentral-fse","icon":"format-image","description":"A block to display a box with an image","keywords":["md-pointcentral-fse","image","box"],"supports":{"html":false},"textdomain":"md-pointcentral-fse","attributes":{"title":{"type":"string","default":""},"imageItems":{"type":"array","default":[]},"buttonLink":{"type":"string","default":""},"numberOfColumns":{"type":"number","default":3},"themeStyle":{"type":"string","default":"default"},"titleColor":{"type":"string","default":""},"imageItemTitleColor":{"type":"string","default":""},"buttonColor":{"type":"string","default":""},"buttonTextColor":{"type":"string","default":""},"showHeading":{"type":"boolean","default":true},"showImageTitle":{"type":"boolean","default":true},"showButton":{"type":"boolean","default":true}},"editorScript":"file:./index.js","style":"file:./style-index.css"}');
