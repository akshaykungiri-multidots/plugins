...
(function ($) {
  ...
  $(".leadership .leadership__author__box .leadership__author__box-item-inner .viewpopup").on("click", function () {
    $(this).parent().parent().parent().siblings(".leadership__popup-model").addClass("open-popup slideInDown");
