...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_healthstream_image_block" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-healthstream")}>
          <SelectControl
            label={__("Image Block Style", "md-healthstream")}
        ...
        >
          <ToggleControl
            label={__("Show Sub Heading", "md-healthstream")}
          ...
          />
          <ToggleControl
            label={__("Show Heading Content", "md-healthstream")}
            checked={showHeadingContent}
            onChange={(value) => setAttributes({ showHeadingContent: value })}
          />
          <ToggleControl
            label={__("Show Image", "md-healthstream")}
            checked={showImage}
          ...
          />
          <ToggleControl
            label={__("Show Content", "md-healthstream")}
            checked={showContent}
            onChange={(value) => setAttributes({ showContent: value })}
          />
          <ToggleControl
            label={__("Show Link", "md-healthstream")}
            checked={showLink}
      ...
      <div className={`md_healthstream_image_block ${imageBlockStyle}`}>
        <div className="md_healthstream_image_block__head">
          <div className="wrapper-inner">
            <div className="md_healthstream_image_block__heading">
              {showSubHeading && (
                <RichText
                  tagName="h3"
                  value={subTitle}
              ...
              {showHeadingContent && (
                <RichText
                  ...
                  placeholder={__("Enter Heading Content", "md-healthstream")}
                  style={{
              ...
              imageBlockList.map((postObj, index) => (
                ...
                >
                  ...
                  <div className="md_healthstream_image_block__item__content">
                    ...
                    <div className="md_healthstream_image_block__item__content__link">
                      {showContent && (
                        <RichText
                          tagName="p"
