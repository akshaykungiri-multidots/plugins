...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_healthstream_card_block" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-healthstream")}>
          <SelectControl
            label={__("Card Block Style", "md-healthstream")}
                ...
                >
                  ...
                  <div className="md_healthstream_card_block__item__content">
                    ...
                    <div className="md_healthstream_card_block__item__content__link">
                      ...
                      {showLink && (
                        <TextControl
                          label={__("Learn More Link", "md-healthstream")}
                          value={postObj.learn_more_link}
                          onChange={(value) =>
                            updateStaticPostObj(index, "learn_more_link", value)
                          }
                          placeholder={__("Enter Link", "md-healthstream")}
                        />
                      )}
                    </div>
                  </div>
