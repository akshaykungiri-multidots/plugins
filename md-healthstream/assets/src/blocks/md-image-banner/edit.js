...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_healthstream_video_header_section" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-healthstream")}>
          <ToggleControl
            label={__("Show Sub Title", "md-healthstream")}
        ...
        <PanelBody title={__("Button Settings")} initialOpen={false}>
          <ToggleControl
            label={__("Show Button", "md-healthstream")}
            checked={showButton}
            ...
            colorSettings={[
              {
                ...
                label: __("Sub Title Color", "md-healthstream"),
              },
              {
                value: titleColor,
                onChange: (colorValue) =>
                  setAttributes({ titleColor: colorValue }),
                label: __("Title Color", "md-healthstream"),
              },
              {
                value: headingContentColor,
                onChange: (colorValue) =>
                  setAttributes({ headingContentColor: colorValue }),
                label: __("Heading Content Color", "md-healthstream"),
              },
              {
              ...
              },
              {
                ...
                label: __("Content Background Color", "md-healthstream"),
              }
            ]}
          />
        </PanelBody>
