...
(function ($) {
  ...
  function getResourceData() {
    const resourceType = $(".storyful-resources .browse-tab-filters__item.active").data("value");
    const resourcesAtts = $(".resources-attributes").val();
    const resourcesCat = $(".storyful-resources .custom-select-filter-wrapper .resource_cat_listing .custom-select-filter__item.active").data("value");
    const filterByDate = $(".storyful-resources .custom-select-filter-wrapper .select-date-filter .custom-select-filter__item.active").data("value");
