    ...
    <div {...useBlockProps()}>
      <InspectorControls>
        ...
        <PanelBody title={__("Toggle Settings", "md-storyful-fse-full")} initialOpen={false}>
          ...
          <ToggleControl
            label={__("Show Testimonial Title", "md-storyful-fse-full")}
            checked={showTestimonialTitle}
            onChange={(value) => setAttributes({ showTestimonialTitle: value })}
          />
          <ToggleControl
            label={__("Show Testimonial Description", "md-storyful-fse-full")}
          ...
          />
          <ToggleControl
            label={__("Show Testimonial Image", "md-storyful-fse-full")}
            checked={showTestimonialImage}
            onChange={(value) => setAttributes({ showTestimonialImage: value })}
          />
        </PanelBody>
        <PanelBody
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                onChange: (value) =>
                  setAttributes({ testimonialTitleFontColor: value }),
                label: __("Testimonial Title Font Color"),
              },
              {
                value: testimonialDescriptionFontColor,
                onChange: (value) =>
                  setAttributes({ testimonialDescriptionFontColor: value }),
