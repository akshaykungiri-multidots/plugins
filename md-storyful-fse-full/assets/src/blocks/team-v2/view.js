...
( function ( $ ) {
	...
	$(
		'.leadership .leadership__author__box .leadership__author__box-item-inner'
	)
		.on( 'click', function () {
			$( this )
	...
	$( '.leadership__popup-model .close,.bg_overlay' ).on(
		'click',
		function () {
			$( '.leadership__popup-model' ).removeClass(
				'open-popup slideInDown'
			);
