			...
			<InspectorControls>
				...
				>
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ showBuyButton: value })
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ showSellButton: value })
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ showLicenseText: value })
						}
					/>
					<ToggleControl
						label={__(
						...
						onChange={(value) =>
							setAttributes({ showLearnMore: value })
						}
					/>
				</PanelBody>
				<PanelBody
