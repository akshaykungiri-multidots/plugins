...
class MD_Storyful_Leaders extends Block_Base
{
	...
	public function render_callback(
		...
		$socialIconBackgroundColor = isset($attributes['socialIconBackgroundColor']) ? $attributes['socialIconBackgroundColor'] : '';
							...
							<div class="leadership__author__box-item">
								<div class="leadership__author__box-item-inner">
									<div class="leadership__author__box-item-inner-img">
										...
										<?php } ?>
										<div class="linked-in-icon wow bounceIn" style="background-color: <?php echo esc_attr($socialIconBackgroundColor); ?>">
									...
									<div class="leadership__author__box-item-inner-content">
										<h3 class="leadershipName wow fadeInUp" style="font-size: <?php echo esc_attr($titleFontSize); ?>; color: <?php echo esc_attr($titleColor); ?>">
											<?php echo wp_kses_post($author_name); ?>
										</h3>
										<p class="leadershipTitle wow fadeInUp" style="font-size: <?php echo esc_attr($descriptionFontSize); ?>; color: <?php echo esc_attr($descriptionColor); ?>">
										...
										<div class="leadership__popup-model-body">
											<div class="leadership__popup-model-author-details-main">
												...
												<div class="leadership__popup-model-author-details-box">
													<h3 class="leadershipName" style="font-size: <?php echo esc_attr($titleFontSize); ?>; color: <?php echo esc_attr($titleColor); ?>">
														<?php echo wp_kses_post($author_name); ?>
													</h3>
											...
											<div class="col-md-8 bio-text leadership__popup-model-about-author-box">
												...
												<div class="leadershipBio" style="font-size: <?php echo esc_attr($descriptionFontSize); ?>; color: <?php echo esc_attr($descriptionColor); ?>">
