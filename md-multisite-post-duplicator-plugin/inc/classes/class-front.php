 ...
 * @subpackage MD_Multisite_Post_Duplicator/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-multisite-post-duplicator-front', MD_MULTISITE_POST_DUPLICATOR_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-multisite-post-duplicator', MD_MULTISITE_POST_DUPLICATOR_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
