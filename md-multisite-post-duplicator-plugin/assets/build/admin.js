        ...
        success: function (response) {
          ...
          if (categories.length > 0) {
            ...
            $.each(categories, function (index, value) {
              categories_html += "<option value='" + value.term_id + "' >" + value.name + "</option>";
            });
          }
          if (tags.length > 0) {
            $("#md_multisite_post_duplicator_is_tags").val("1");
            $.each(tags, function (index, value) {
              tags_html += "<option value='" + value.term_id + "' >" + value.name + "</option>";
            });
          }
...
/* harmony import */ var _admin_select2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./admin/select2 */ "./src/js/admin/select2.js");
/* harmony import */ var _admin_select2__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_admin_select2__WEBPACK_IMPORTED_MODULE_2__);
// Styles
