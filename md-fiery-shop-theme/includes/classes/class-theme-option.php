...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-fiery-shop', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-fiery-shop-theme-options">
				<div class="md-fiery-shop-theme-options-header">
					<h1>MD Fiery Shop Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-fiery-shop&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-fiery-shop' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-fiery-shop-setting' );
					do_settings_sections( 'md-fiery-shop' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-fiery-shop-setting', 'md_fiery_shop_settings' );
		add_settings_section( 'md-fiery-shop-section', __( 'General Settings', 'md-fiery-shop' ), '__return_empty_string', 'md-fiery-shop' );
		add_settings_field(
			'md_fiery_shop_logo',
			__( 'Site Logo:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'file',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_img]',
				'value' => 'md_fiery_shop_img',
			)
		);
		add_settings_field(
			'md_fiery_shop_favicon',
			__( 'Site Favicon:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'file',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_favicon]',
				'value' => 'md_fiery_shop_favicon',
			)
		);
		add_settings_field(
			'md_fiery_shop_tagline',
			__( 'Site Tagline:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'text',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_tagline]',
				'value' => 'md_fiery_shop_tagline',
			)
		);
		add_settings_field(
			'md_fiery_shop_google_analytic',
			__( 'Google Analytic:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_google_analytic]',
				'value' => 'md_fiery_shop_google_analytic',
			)
		);
		add_settings_field(
			'md_fiery_shop_css_code',
			__( 'Additional CSS:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_css_code]',
				'value' => 'md_fiery_shop_css_code',
			)
		);
		add_settings_field(
			'md_fiery_shop_html_code',
			__( 'Additional html:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_html_code]',
				'value' => 'md_fiery_shop_html_code',
			)
		);
		add_settings_field(
			'md_fiery_shop_color_picker',
			__( 'Color:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_color_picker]',
				'value' => 'md_fiery_shop_color_picker',
			)
		);
		add_settings_field(
			'md_fiery_shop_wysiwyg',
			__( 'Text Editor:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_wysiwyg]',
				'value' => 'md_fiery_shop_wysiwyg',
			)
		);
		add_settings_field(
			'md_fiery_shop_password',
			__( 'Manage Password:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'password',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_password]',
				'id'    => 'password',
				'value' => 'md_fiery_shop_password',
			)
		);
		add_settings_field(
			'md_fiery_shop_selectbox',
			__( 'Select Option:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'    => 'select',
				'name'    => 'md_fiery_shop_settings[md_fiery_shop_selectbox]',
				'value'   => 'md_fiery_shop_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_fiery_shop_multiselect',
			__( 'Select Multiple Option:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_fiery_shop_settings[md_fiery_shop_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_fiery_shop_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_fiery_shop_radio',
			__( 'Select Radio Option:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_fiery_shop_settings[md_fiery_shop_radio]',
				'value'   => 'md_fiery_shop_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_fiery_shop_checkbox',
			__( 'Select Checkbox Option:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_checkbox]',
				'value' => 'md_fiery_shop_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_fiery_shop_number',
			__( 'Number:', 'md-fiery-shop' ),
			array( $this, 'add_field' ),
			'md-fiery-shop',
			'md-fiery-shop-section',
			array(
				'type'  => 'number',
				'name'  => 'md_fiery_shop_settings[md_fiery_shop_number]',
				'value' => 'md_fiery_shop_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_fiery_shop_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_fiery_shop_img" 
			...
			?>
		/>
		<input class="md_fiery_shop_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_fiery_shop_img_upload"><button>Upload</button></a>
		<a href="#" class="md_fiery_shop_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_FIERY_SHOP_BUILD_URI . '/themeoption.css', array(), filemtime( MD_FIERY_SHOP_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_FIERY_SHOP_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_FIERY_SHOP_BUILD_PATH . '/themeoption.js' ), true );
