 ...
 * @subpackage MD_Migrate_Resources/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-migrate-resources-front', MD_MIGRATE_RESOURCES_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-migrate-resources', MD_MIGRATE_RESOURCES_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
