 ...
 * @subpackage MD_Bakery_Antian/public
...
class Front {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'md-bakery-antian-front', MD_BAKERY_ANTIAN_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'md-bakery-antian', MD_BAKERY_ANTIAN_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
