 ...
 * @subpackage MD_Circle_Plus/public
...
class Front {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'md-circle-plus-front', MD_CIRCLE_PLUS_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-circle-plus', MD_CIRCLE_PLUS_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
