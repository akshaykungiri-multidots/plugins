...
/**
 * Circle_Logo_Slider_Plus class
 * 
 * @since 1.0.0
 */
class Circle_Logo_Slider_Plus extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'circle_logo_slider_plus';
	}
	...
	public function get_title() {
		return esc_html__( 'Circle Logo Slider Plus', 'md-circle-plus' );
	}
	...
	public function get_keywords() {
		return [ 'circle', 'logo', 'slider', 'plus' ];
	}
	...
	protected function render() {
        ...
        ?>
        <div class="circle-logo-slider-plus">
			<div class="marquee">
				<div class="circle-logo-slider-plus__inner track">
					<?php foreach ( $settings['logo_slider'] as $image ) : ?>
						<div class="circle-logo-slider-plus__item">
	...
	protected function content_template() {
        ?>
        <div class="circle-logo-slider-plus">
            <div class="circle-logo-slider-plus__inner">
