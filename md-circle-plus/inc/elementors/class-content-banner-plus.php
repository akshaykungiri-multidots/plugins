...
/**
 * Content_Banner_Plus class
 * 
 * @since 1.0.0
 */
class Content_Banner_Plus extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'content-banner-plus-plus';
	}
	...
	public function get_title() {
		return esc_html__( 'Content Banner Plus', 'md-circle-plus' );
	}
	...
	protected function register_controls() {
        ...
        $nested_repeater->add_control(
            'sub_field_title',
            [
                'label' => __( 'Sub Field Title', 'md-circle-plus' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Sub Title' , 'md-circle-plus' ),
                'label_block' => true,
            ]
        );
        ...
        $nested_repeater->add_control(
            'sub_field_content',
            [
                'label' => __( 'Sub Field Content', 'md-circle-plus' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __( 'Sub Content' , 'md-circle-plus' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'field_title',
            [
                'label' => __( 'Field Title', 'md-circle-plus' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Title' , 'md-circle-plus' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'field_content',
            [
                'label' => __( 'Field Content', 'md-circle-plus' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __( 'Content' , 'md-circle-plus' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'sub_fields',
            [
                'label' => __( 'Sub Fields', 'md-circle-plus' ),
        ...
        $this->add_control(
            'fields',
            [
                'label' => __( 'Fields', 'md-circle-plus' ),
                'type' => \Elementor\Controls_Manager::REPEATER,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .content h1' => 'color: {{VALUE}};',
					'{{WRAPPER}} .content h2' => 'color: {{VALUE}};',
					'{{WRAPPER}} .content h3' => 'color: {{VALUE}};',
					'{{WRAPPER}} .content h4' => 'color: {{VALUE}};',
					'{{WRAPPER}} .content h5' => 'color: {{VALUE}};',
					'{{WRAPPER}} .content h6' => 'color: {{VALUE}};',
