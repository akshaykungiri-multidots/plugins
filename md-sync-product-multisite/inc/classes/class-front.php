 ...
 * @subpackage MD_Sync_Product_Multisite/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-sync-product-multisite-front', MD_SYNC_PRODUCT_MULTISITE_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-sync-product-multisite', MD_SYNC_PRODUCT_MULTISITE_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
