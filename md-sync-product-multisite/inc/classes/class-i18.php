...
class I18 {
	 ...
	 *
	 * Uses the MD_Sync_Product_Multisite_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	public function set_locale() {
		...
		$locale = apply_filters( 'plugin_locale', get_locale(), 'md-sync-product-multisite' );
		load_textdomain( 'md-sync-product-multisite', plugin_dir_path( dirname( __FILE__ ) ) . '/languages/' . $locale . '.mo' );
