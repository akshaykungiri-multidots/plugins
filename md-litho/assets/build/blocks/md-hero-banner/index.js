...
/* harmony import */ var _fontIcons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fontIcons */ "./src/blocks/md-hero-banner/fontIcons.js");
...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Social Links"),
    checked: showSocialLinks,
    onChange: value => setAttributes({
      showSocialLinks: value
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show Icon List"),
  ...
  }), showBackgroundImage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    colorSettings: [{
      ...
      onChange: value => setAttributes({
        iconTitleColor: value
      }),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Icon Title Color")
    }, {
      value: iconDescriptionColor,
      onChange: value => setAttributes({
        iconDescriptionColor: value
      }),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Icon Description Color")
    }, {
      value: iconListBackgroundColor,
      onChange: value => setAttributes({
        iconListBackgroundColor: value
      }),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Icon List Background Color")
    }]
    ...
    className: "md_hero_banner__content__wrap"
  ...
  }), showSocialLinks && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks, {
    allowedBlocks: ALLOWED_BLOCKS
  }))))), showIconList && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `md_icon_block__slider_wrap container`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "md_icon_block__slider"
  }, iconList && iconList.map((postObj, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: postObj.id,
    className: "logo-slide show-items-hover-wrap",
    style: {
      backgroundColor: iconListBackgroundColor
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  })), index + 1 < iconList.length && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Tooltip, {
  ...
  }))), 1 < iconList.length && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Tooltip, {
    ...
    onClick: () => {
      ...
      if (toDelete) {
        const updatedArray = iconList.filter((item, itemIndex) => itemIndex !== index);
        setAttributes({
  ...
  }, postObj.icon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/***/ "./src/blocks/md-hero-banner/fontIcons.js":
/*!************************************************!*\
  !*** ./src/blocks/md-hero-banner/fontIcons.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function save({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Description", "md-prime"),
    allowedFormats: ["core/bold", "core/italic", "core/underline"]
  }), showSocialLinks && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks.Content, null))))), showIconList && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `md_icon_block__slider_wrap container`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "md_icon_block__slider"
  }, iconList && iconList.map(postObj => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: postObj.id,
    className: "logo-slide show-items-hover-wrap",
    style: {
      backgroundColor: iconListBackgroundColor
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","name":"md-litho/md-hero-banner","version":"0.1.0","title":"MD Hero Banner","apiVersion":3,"category":"md-litho","icon":"format-image","description":"A block that displays a hero banner.","keywords":["hero","banner"],"supports":{"html":false,"align":["wide","full"]},"textdomain":"md-litho","attributes":{"title":{"type":"string","default":""},"description":{"type":"string","default":""},"socialLinks":{"type":"array","default":[]},"backgroundImage":{"type":"string","default":""},"iconList":{"type":"array","default":[]},"showTitle":{"type":"boolean","default":true},"showDescription":{"type":"boolean","default":true},"showSocialLinks":{"type":"boolean","default":true},"showIconList":{"type":"boolean","default":true},"showBackgroundImage":{"type":"boolean","default":true},"titleColor":{"type":"string","default":""},"descriptionColor":{"type":"string","default":""},"iconColor":{"type":"string","default":""},"iconTitleColor":{"type":"string","default":""},"iconDescriptionColor":{"type":"string","default":""},"iconListBackgroundColor":{"type":"string","default":""}},"editorScript":"file:./index.js","style":"file:./style-index.css"}');
