...
export default function save({ attributes }) {
  ...
  return (
    <div {...useBlockProps.save()}>
      <div className="md_image_block">
        <div className="md_image_block__heading">
          {showSubHeading && (
            <RichText.Content
              tagName="h4"
        ...
        {showLogos && (
          <div className={`md_image_block__slider_wrap`}>
            <div className="md_image_block__slider">
              {logos &&
                logos.map((postObj) => (
                  <div
                    key={postObj.id}
                  ...
                  >
                    <div className="md-lithomd_image_block__item-icon">
                      <div className="md-lithomd_image_block__item-icon__wrapper">
                        {showLogosIcon && postObj.mediaImage && (
                          <div className="md-lithomd_image_block__item-icon__wrapper-icon">
                        ...
                        <div className="md-lithomd_image_block__item-icon__wrapper-text">
                          {showLogosTitle && (
                            <RichText.Content
                              tagName="h4"
        ...
        {showButton && (
          <div className="md_image_block__button">
            <RichText.Content
              tagName="p"
              className="button"
              value={buttonText}
