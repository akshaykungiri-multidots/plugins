...
(function ($) {
	...
	$(
		'.testimonials .testimonials__author__box .testimonials__author__box-item-inner'
	)
		.on('click', function () {
			$(this)
				.siblings('.testimonials__popup-model')
	...
	$(document).keyup(function (e) {
		if (
			27 === e.keyCode &&
			$('.testimonials__popup-model').hasClass('open-popup')
		) {
			$('.testimonials__popup-model').removeClass('open-popup slideInDown');
		}
	});
