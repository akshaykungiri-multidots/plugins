  ...
  return (
    ...
    >
      <InspectorControls>
        ...
        {currentSlide >= 0 && currentSlide in slideItems && (
          <PanelBody title={__("Current Slide Settings")} initialOpen={false}>
            ...
            <div className="md_slider_v2__background_settings">
              <ToggleControl
      ...
      <div className="md_slider_v2__media">
        <div className="md-prime-block-control image-preview image-controle-visible-hover md_litho_image_banner_v2__media1">
          <div className={`image-controls small-icons icon-center-fixed`}>
            <MediaUploadCheck>
              <MediaUpload
                onSelect={(media) => setAttributes({ headingCircleImage: media.url })}
                allowedTypes={["image"]}
                      ...
                      <>
                        ...
                        <Tooltip text={__("Remove Image", "md-prime")}>
                          <i
                            ...
                            onClick={() => setAttributes({ headingCircleImage: "" })}
                            role="button"
                            tabIndex={0}
                            onKeyDown={(e) => {
                              if (e.key === "Enter" || e.key === " ") {
                                e.preventDefault();
                                setAttributes({ headingCircleImage: "" });
                              }
                            }}
          ...
          <img
            src={headingCircleImage ? headingCircleImage : siteURL + placeholder}
            alt={"slider"}
          />
        </div>
      </div>
          ...
          {showFeatureBox1 && (
            <div className="md_slider_v2__heading__feature-box">
              <RichText
                ...
                onChange={(value) => setAttributes({ featureBox1Title: value })}
                placeholder={__("Enter Title", "md-prime")}
              ...
              <RichText
                ...
                onChange={(value) =>
                  setAttributes({ featureBox1Description: value })
                }
          ...
          {showFeatureBox2 && (
            <div className="md_slider_v2__heading__feature-box">
              <RichText
                ...
                onChange={(value) => setAttributes({ featureBox2Title: value })}
                placeholder={__("Enter Title", "md-prime")}
              ...
              <RichText
                ...
                onChange={(value) =>
                  setAttributes({ featureBox2Description: value })
                }
                placeholder={__("Enter Description", "md-prime")}
      ...
      <div className="md_hero_banner_slider md_slider_v2_grid">
        <Slider {...settings} className="md_slider_v2" ref={sliderRef}>
