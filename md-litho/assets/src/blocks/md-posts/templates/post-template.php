        ...
        <div class="md-posts__grid-item-inner">
            <div class="md-posts__grid-item-header">
                ...
                <div class="md-posts__grid-item-header-right">
                    ...
                    <?php endif; ?>
                    <?php if ($number_of_comments) : ?>
                        <div class="md-posts__grid-item-footer-right">
                            <div class="md-posts__grid-item-comments">
                                <span class="md-posts__grid-item-comments-icon">
                                    <i class="fa fa-comment"></i>
                                </span>
                                <span class="md-posts__grid-item-comments-count">
                                    <?php echo esc_html($number_of_comments); ?>
                                </span>
                            </div>
                        </div>
                    <?php endif; ?>
...
if ($enableViewAll) :
    ...
    if ($view_all_link) { ?>
        <a href="<?php echo esc_url($view_all_link); ?>" class="md-posts__view-all-link md-btn-main btn-link-right-arrow"><?php esc_html_e('View All', 'md-litho'); ?></a>
<?php }
endif;
?>