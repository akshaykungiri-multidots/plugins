...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-litho', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-litho-theme-options">
				<div class="md-litho-theme-options-header">
					<h1>MD Litho Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-litho&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-litho' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-litho-setting' );
					do_settings_sections( 'md-litho' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-litho-setting', 'md_litho_settings' );
		add_settings_section( 'md-litho-section', __( 'General Settings', 'md-litho' ), '__return_empty_string', 'md-litho' );
		add_settings_field(
			'md_litho_logo',
			__( 'Site Logo:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'file',
				'name'  => 'md_litho_settings[md_litho_img]',
				'value' => 'md_litho_img',
			)
		);
		add_settings_field(
			'md_litho_favicon',
			__( 'Site Favicon:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'file',
				'name'  => 'md_litho_settings[md_litho_favicon]',
				'value' => 'md_litho_favicon',
			)
		);
		add_settings_field(
			'md_litho_tagline',
			__( 'Site Tagline:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'text',
				'name'  => 'md_litho_settings[md_litho_tagline]',
				'value' => 'md_litho_tagline',
			)
		);
		add_settings_field(
			'md_litho_google_analytic',
			__( 'Google Analytic:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_litho_settings[md_litho_google_analytic]',
				'value' => 'md_litho_google_analytic',
			)
		);
		add_settings_field(
			'md_litho_css_code',
			__( 'Additional CSS:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_litho_settings[md_litho_css_code]',
				'value' => 'md_litho_css_code',
			)
		);
		add_settings_field(
			'md_litho_html_code',
			__( 'Additional html:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_litho_settings[md_litho_html_code]',
				'value' => 'md_litho_html_code',
			)
		);
		add_settings_field(
			'md_litho_color_picker',
			__( 'Color:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_litho_settings[md_litho_color_picker]',
				'value' => 'md_litho_color_picker',
			)
		);
		add_settings_field(
			'md_litho_wysiwyg',
			__( 'Text Editor:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_litho_settings[md_litho_wysiwyg]',
				'value' => 'md_litho_wysiwyg',
			)
		);
		add_settings_field(
			'md_litho_password',
			__( 'Manage Password:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'password',
				'name'  => 'md_litho_settings[md_litho_password]',
				'id'    => 'password',
				'value' => 'md_litho_password',
			)
		);
		add_settings_field(
			'md_litho_selectbox',
			__( 'Select Option:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'    => 'select',
				'name'    => 'md_litho_settings[md_litho_selectbox]',
				'value'   => 'md_litho_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_litho_multiselect',
			__( 'Select Multiple Option:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_litho_settings[md_litho_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_litho_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_litho_radio',
			__( 'Select Radio Option:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_litho_settings[md_litho_radio]',
				'value'   => 'md_litho_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_litho_checkbox',
			__( 'Select Checkbox Option:', 'md-litho' ),
			array( $this, 'add_field' ),
			'md-litho',
			'md-litho-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_litho_settings[md_litho_checkbox]',
				'value' => 'md_litho_checkbox',
		...
		add_settings_field(
			...
			array(
				'type'  => 'number',
				'name'  => 'md_litho_settings[md_litho_number]',
				'value' => 'md_litho_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_litho_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_litho_img" 
			...
			?>
		/>
		<input class="md_litho_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_litho_img_upload"><button>Upload</button></a>
		<a href="#" class="md_litho_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_LITHO_BUILD_URI . '/themeoption.css', array(), filemtime( MD_LITHO_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_LITHO_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_LITHO_BUILD_PATH . '/themeoption.js' ), true );
