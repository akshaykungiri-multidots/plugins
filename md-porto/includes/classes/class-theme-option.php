...
class Theme_Option {
	...
	public function add_option_menu(): void {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-porto', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form(): void {
		?>
		<div class="wrap">
			<div class="md-porto-theme-options">
				<div class="md-porto-theme-options-header">
					<h1>MD Porto Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-porto&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-porto' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'>
					<?php
					settings_fields( 'md-porto-setting' );
					do_settings_sections( 'md-porto' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init(): void {
		register_setting( 'md-porto-setting', 'md_porto_settings' );
		add_settings_section( 'md-porto-section', __( 'General Settings', 'md-porto' ), '__return_empty_string', 'md-porto' );
		add_settings_field(
			'md_porto_logo',
			__( 'Site Logo:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'file',
				'name'  => 'md_porto_settings[md_porto_img]',
				'value' => 'md_porto_img',
			)
		);
		add_settings_field(
			'md_porto_favicon',
			__( 'Site Favicon:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'file',
				'name'  => 'md_porto_settings[md_porto_favicon]',
				'value' => 'md_porto_favicon',
			)
		);
		add_settings_field(
			'md_porto_tagline',
			__( 'Site Tagline:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'text',
				'name'  => 'md_porto_settings[md_porto_tagline]',
				'value' => 'md_porto_tagline',
			)
		);
		add_settings_field(
			'md_porto_google_analytic',
			__( 'Google Analytic:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_porto_settings[md_porto_google_analytic]',
				'value' => 'md_porto_google_analytic',
			)
		);
		add_settings_field(
			'md_porto_css_code',
			__( 'Additional CSS:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_porto_settings[md_porto_css_code]',
				'value' => 'md_porto_css_code',
			)
		);
		add_settings_field(
			'md_porto_html_code',
			__( 'Additional html:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_porto_settings[md_porto_html_code]',
				'value' => 'md_porto_html_code',
			)
		);
		add_settings_field(
			'md_porto_color_picker',
			__( 'Color:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_porto_settings[md_porto_color_picker]',
				'value' => 'md_porto_color_picker',
			)
		);
		add_settings_field(
			'md_porto_wysiwyg',
			__( 'Text Editor:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_porto_settings[md_porto_wysiwyg]',
				'value' => 'md_porto_wysiwyg',
			)
		);
		add_settings_field(
			'md_porto_password',
			__( 'Manage Password:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'password',
				'name'  => 'md_porto_settings[md_porto_password]',
				'id'    => 'password',
				'value' => 'md_porto_password',
			)
		);
		add_settings_field(
			'md_porto_selectbox',
			__( 'Select Option:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'    => 'select',
				'name'    => 'md_porto_settings[md_porto_selectbox]',
				'value'   => 'md_porto_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_porto_multiselect',
			__( 'Select Multiple Option:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_porto_settings[md_porto_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_porto_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_porto_radio',
			__( 'Select Radio Option:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_porto_settings[md_porto_radio]',
				'value'   => 'md_porto_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_porto_checkbox',
			__( 'Select Checkbox Option:', 'md-porto' ),
			array( $this, 'add_field' ),
			'md-porto',
			'md-porto-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_porto_settings[md_porto_checkbox]',
				'value' => 'md_porto_checkbox',
		...
		add_settings_field(
			...
			array(
				'type'  => 'number',
				'name'  => 'md_porto_settings[md_porto_number]',
				'value' => 'md_porto_number',
			)
		);
	}
	...
	public function add_field( array $args ): void {
		$options = ! empty( get_option( 'md_porto_settings' ) ) ? get_option( 'md_porto_settings' ) : array();
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( array $args, array $options ): void {
		...
		<img class="md_porto_img"
			...
			?>
		/>
		<input class="md_porto_img_url"
			type="hidden"
			name="<?php echo esc_attr( $args['name'] ); ?>"
			size="60"
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_porto_img_upload"><button>Upload</button></a>
		<a href="#" class="md_porto_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets(): void {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_PORTO_BUILD_URI . '/themeoption.css', array(), MD_PORTO_THEME_VERSION, 'all' );
		...
		wp_register_script( 'theme-option-js', MD_PORTO_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), MD_PORTO_THEME_VERSION, true );
