...
class Assets {
	...
	public function move_scripts_to_footer(): void {
		...
		wp_enqueue_script( 'jquery-core', '/wp-includes/js/jquery/jquery.min.js', array(), MD_PORTO_THEME_VERSION, true );
	}
	...
	public function hook_critical_css(): void {
		...
		$response = wp_remote_get( MD_PORTO_BUILD_URI . '/inline.css' );   // load template output in buffer.

		if ( ! is_wp_error( $response ) ) {
			$css = wp_remote_retrieve_body( $response );
			wp_register_style( 'md-porto-inline-css', false, array(), MD_PORTO_THEME_VERSION, true );
			wp_add_inline_style( 'md-porto-inline-css', $css );
			wp_enqueue_style( 'md-porto-inline-css' );
		}
	}
	...
	public function register_styles(): void {
		...
		// Register styles.
		wp_register_style( 'main-css', MD_PORTO_BUILD_URI . '/main.css', array(), MD_PORTO_THEME_VERSION, 'all' );
	...
	public function register_scripts(): void {
		...
		// Register scripts.
		wp_register_script( 'main-js', MD_PORTO_BUILD_URI . '/main.js', array( 'jquery-core' ), MD_PORTO_THEME_VERSION, true );
	...
	public function enqueue_editor_assets(): void {
		...
		if ( is_admin() ) {
			wp_enqueue_style(
				'md-porto-editor-css',
				MD_PORTO_BUILD_URI . '/geditor.css',
				array(),
				MD_PORTO_THEME_VERSION,
				'all'
			);
		}
