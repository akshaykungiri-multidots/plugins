...
namespace MD_PORTO\Includes\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( static::$_instance[ $called_class ] ) ) {
			...
			/*
			 * Dependent items can use the `md_porto_singleton_init_{$called_class}` hook to execute code
			 * immediately after _init() is called.
			 */
			do_action( sprintf( 'md_porto_singleton_init_%s', $called_class ) );
