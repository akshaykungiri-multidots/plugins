        ...
        <div class="md-posts__grid-item-inner">
            ...
            <div class="md-posts__grid-item-content">
                ...
                <div class="md-posts__grid-item-read-more">
                    <a href="<?php the_permalink(); ?>" class="md-btn-main btn-link-right-arrow"><?php esc_html_e('Explore Services', 'md-porto'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
if ($enableViewAll) :
    ...
    if ($view_all_link) { ?>
        <a href="<?php echo esc_url($view_all_link); ?>" class="md-posts__view-all-link md-btn-main btn-link-right-arrow"><?php esc_html_e('View All', 'md-porto'); ?></a>
    <?php }
endif;
?>