...
export default function Edit({ attributes, setAttributes, clientId }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_porto_video_header_section" })}>
      <InspectorControls>
        <PanelBody title={__("Video Settings", "md-porto")} initialOpen={true}>
        ...
        <PanelBody
          title={__("Background Settings", "md-porto")}
          initialOpen={false}
        >
          ...
          <ToggleControl
            label={__("Enable Overlay", "md-porto")}
          ...
          {enableOverlay && (
            <Fragment>
              <PanelColorSettings
                title={__("Overlay Color", "md-porto")}
                initialOpen={false}
                colorSettings={[
                  {
                    value: overlayColor,
                    ...
                    label: __("Overlay Color", "md-porto"),
                  },
                ]}
              />
              <RangeControl
                label={__("Overlay Opacity", "md-porto")}
        ...
        >
          ...
          />
          <ToggleControl
            label={__("Show Video Footer Text", "md-porto")}
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                label: __("Description Color", "md-porto"),
              },
              {
              ...
              },
              {
                ...
                label: __("Video Footer Text Color", "md-porto"),
              },
            ]}
          />
        </PanelBody>
      ...
      <style>
        {`
            #block-${blockId} .md_porto_text_video__button .md_btn {
              color: ${buttonColor} !important;
              background: ${buttonBackgroundColor} !important;
              border-color: ${buttonColor} !important;
            }
            #block-${blockId} .md_porto_text_video__button .md_btn:hover {
      ...
      <div
        className="md_porto_text_video_wrap"
        style={{ backgroundImage: `url(${backgroundImage})` }}
      >
        {enableOverlay && (
          <div
            className="md_porto_text_video_overlay"
            style={{
        ...
        <div
          className="md_porto_text_video"
          style={{
            background: `${backgroundColor}`,
          }}
        >
          <div className="md_porto_text_video__inner">
            <div className="md_porto_text_video__heading">
              {showSubHeading && (
              ...
              {showDescription && (
                <RichText
                  tagName="p"
                  className="md_porto_text_video__description"
                  value={description}
                  onChange={(value) => setAttributes({ description: value })}
                  placeholder={__("Enter Description", "md-porto")}
                  style={{ color: descriptionColor }}
                />
              )}
              {showButton && (
                <div className="md_porto_text_video__button">
                  <div
            ...
            <div className="md_porto_text_video__youtube">
              <div className="md_porto_text_video__youtube_icon">
                <button
              ...
              <div
                className={`porto_video_popup__wrap ${
                  displayPopup ? "show-popup" : ""
                }`}
              >
                <div className="porto_video_popup__inner">
                  <div className="porto_video_popup__inner-header">
                    <i
                  ...
                  <div className="porto_video_popup__inner-content">
                    <div className="text_video__youtube">
                      <div className="video_section_wrapper" id="MdYTplayer">
                        <div className="wrapper__box-inner">
                          <div
          ...
          <div className="md_porto_text_video__footer">
            {showVideoFooterText && (
              <RichText
                tagName="p"
                value={videoFooterText}
                onChange={(value) => setAttributes({ videoFooterText: value })}
                placeholder={__("Enter Footer Text", "md-porto")}
