 ...
 * @subpackage MD_Foursquare/public
...
class Front {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'md-foursquare-front', MD_FOURSQUARE_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'md-foursquare', MD_FOURSQUARE_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
