...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-sutherlandglobal', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-sutherlandglobal-theme-options">
				<div class="md-sutherlandglobal-theme-options-header">
					<h1>MD Sutherlandglobal Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-sutherlandglobal&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-sutherlandglobal' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-sutherlandglobal-setting' );
					do_settings_sections( 'md-sutherlandglobal' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-sutherlandglobal-setting', 'md_sutherlandglobal_settings' );
		add_settings_section( 'md-sutherlandglobal-section', __( 'General Settings', 'md-sutherlandglobal' ), '__return_empty_string', 'md-sutherlandglobal' );
		add_settings_field(
			'md_sutherlandglobal_logo',
			__( 'Site Logo:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'file',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_img]',
				'value' => 'md_sutherlandglobal_img',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_favicon',
			__( 'Site Favicon:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'file',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_favicon]',
				'value' => 'md_sutherlandglobal_favicon',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_tagline',
			__( 'Site Tagline:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'text',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_tagline]',
				'value' => 'md_sutherlandglobal_tagline',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_google_analytic',
			__( 'Google Analytic:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_google_analytic]',
				'value' => 'md_sutherlandglobal_google_analytic',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_css_code',
			__( 'Additional CSS:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_css_code]',
				'value' => 'md_sutherlandglobal_css_code',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_html_code',
			__( 'Additional html:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_html_code]',
				'value' => 'md_sutherlandglobal_html_code',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_color_picker',
			__( 'Color:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_color_picker]',
				'value' => 'md_sutherlandglobal_color_picker',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_wysiwyg',
			__( 'Text Editor:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_wysiwyg]',
				'value' => 'md_sutherlandglobal_wysiwyg',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_password',
			__( 'Manage Password:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'password',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_password]',
				'id'    => 'password',
				'value' => 'md_sutherlandglobal_password',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_selectbox',
			__( 'Select Option:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'    => 'select',
				'name'    => 'md_sutherlandglobal_settings[md_sutherlandglobal_selectbox]',
				'value'   => 'md_sutherlandglobal_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_sutherlandglobal_multiselect',
			__( 'Select Multiple Option:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_sutherlandglobal_settings[md_sutherlandglobal_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_sutherlandglobal_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_sutherlandglobal_radio',
			__( 'Select Radio Option:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_sutherlandglobal_settings[md_sutherlandglobal_radio]',
				'value'   => 'md_sutherlandglobal_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_sutherlandglobal_checkbox',
			__( 'Select Checkbox Option:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_checkbox]',
				'value' => 'md_sutherlandglobal_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_sutherlandglobal_number',
			__( 'Number:', 'md-sutherlandglobal' ),
			array( $this, 'add_field' ),
			'md-sutherlandglobal',
			'md-sutherlandglobal-section',
			array(
				'type'  => 'number',
				'name'  => 'md_sutherlandglobal_settings[md_sutherlandglobal_number]',
				'value' => 'md_sutherlandglobal_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_sutherlandglobal_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		?>
		<img class="md_sutherlandglobal_img" 
			...
			?>
		/>
		<input class="md_sutherlandglobal_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_sutherlandglobal_img_upload"><button>Upload</button></a>
		<a href="#" class="md_sutherlandglobal_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_SUTHERLANDGLOBAL_BUILD_URI . '/themeoption.css', array(), filemtime( MD_SUTHERLANDGLOBAL_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_SUTHERLANDGLOBAL_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_SUTHERLANDGLOBAL_BUILD_PATH . '/themeoption.js' ), true );
