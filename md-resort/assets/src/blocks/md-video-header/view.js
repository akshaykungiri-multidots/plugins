...
(function () {
  ...
  const wordsToType = document
      .querySelector(".md_resort_text_video__typing")
      .getAttribute("data-typing-words")
      .split(","),
    typer = jQuery(".md_resort_text_video__typing"),
  ...
  jQuery(document).ready(function ($) {
    $(".md_resort_text_video__youtube_icon .play-button").on("click", function () {
      $(".resort_video_popup__wrap").addClass("show-popup");
    });
    $(".resort_video_popup__inner-header .close-popup").on("click", function () {
      $(".resort_video_popup__wrap").removeClass("show-popup");
    });
  });
})(jQuery);
