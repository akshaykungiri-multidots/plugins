...
export default function save({ attributes }) {
  ...
  return (
    <div {...useBlockProps.save({ className: "md_resort_pricing_table_section" })}>
      <div className="md_resort_pricing_table_section_wrap">
        <div className="md_resort_pricing_table_heading">
          {showSubHeading && (
            <RichText.Content
              tagName="h4"
              value={subHeading}
        ...
        <div className="md_resort_pricing_table_wrap">
          {pricingTable &&
            pricingTable.map((postObj) => (
              <div
                key={postObj.id}
                className="md_resort_pricing_table_item show-items-hover-wrap"
              >
                <div
                  className={`md_resort_pricing_table_item_inner ${
                    postObj.isHighlighted ? "highlighted" : ""
                  }`}
                >
                  <div className="md_resort_pricing_table_item_highlighted">
                    {postObj.isHighlighted && (
                      <RichText.Content
                        tagName="div"
                        className="md_resort_pricing_table_item_highlighted_text"
                  ...
                  <div
                    className="md_resort_pricing_table_item_header"
                    style={{
                  ...
                  >
                    {showPricingTableSubTitle && (
                      <RichText.Content
                        tagName="h4"
                        className="md_resort_pricing_table_item_sub_title"
                    ...
                    {showPricingTableTitle && (
                      <RichText.Content
                        tagName="h3"
                        className="md_resort_pricing_table_item_title"
                        value={postObj.title}
                    ...
                    <div className="md_resort_pricing_table_item_features">
                      {showPricingTableFeatures && (
                        <div className="md_resort_pricing_table_item_features_inner">
                          <ul
                            style={{
                              color: postObj.isHighlighted
                                ? highlightedPricingTableFeaturesColor
                          ...
                          >
                            {postObj.planFeatures.map(
                              (feature) => (
                                <li
                                  key={feature.id}
                                  className="md_resort_pricing_table_item_feature show-items-hover-wrap"
                                >
                                  <i
                                    className={
                                      feature.isIncluded
                  ...
                  <div
                    className="md_resort_pricing_table_item_footer"
                    style={{
                      backgroundColor: postObj.isHighlighted
                        ? highlightedPricingTableFooterBackgroundColor
                        : pricingTableFooterBackgroundColor,
                  ...
                  >
                    <div className="md_resort_pricing_table_item_price_wrap">
                      {showPricingTablePrice && (
                        <RichText.Content
                          tagName="span"
                          className="md_resort_pricing_table_item_price"
                          value={postObj.price}
                      ...
                      {showPricingTablePrice && (
                        <RichText.Content
                          tagName="span"
                          className="md_resort_pricing_table_item_price_term"
                    ...
                    <div className="md_resort_pricing_table_item_button_wrap">
                      {showPricingTableButton && (
                        <RichText.Content
                          tagName="p"
                          className="md_resort_pricing_table_item_button"
                      ...
                      {showPricingTableFooter && (
                        <RichText.Content
                          className="md_resort_pricing_table_item_footer_text"
                          tagName="p"
      ...
      <div className="md_resort_features_list_wrap">
        {showFeaturesList && (
          <div className="md_resort_features_list">
            {featuresList &&
              featuresList.map((feature) => (
                <div
                  key={feature.id}
                  className="md_resort_features_list_item show-items-hover-wrap"
                >
