...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_resort_service_banner_section" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-resort")}>
          <ToggleControl
            label={__("Show Sub Title", "md-resort")}
          ...
          />
          <ToggleControl
            label={__("Show Counter Number", "md-resort")}
            checked={showCounterNumber}
            onChange={(value) => setAttributes({ showCounterNumber: value })}
          />
          <ToggleControl
            label={__("Show Review Text", "md-resort")}
            checked={showReviewText}
            onChange={(value) => setAttributes({ showReviewText: value })}
          />
        </PanelBody>
        <PanelBody
          title={__("Highlighted Text Settings", "md-resort")}
          initialOpen={false}
        >
          <ToggleControl
            label={__("Show Highlighted Text", "md-resort")}
          ...
          {showHighlightedText && (
            <Fragment>
              ...
              <PanelColorSettings
                title={__("Highlighted Text Colors", "md-resort")}
                initialOpen={false}
                colorSettings={[
                  {
                    ...
                    label: __("Text Color", "md-resort"),
                  },
                ]}
              />
              <div className="settings-row">
                <label htmlFor="highlightedTextColor">
                  {__("Highlighted Text Background Color", "md-resort")}
                </label>
                <GradientPicker
        ...
        <PanelBody
          title={__("Review Stars Settings", "md-resort")}
          initialOpen={false}
        >
          <ToggleControl
            label={__("Show Review Stars", "md-resort")}
          ...
          {showReviewStars && (
            <Fragment>
              <RangeControl
                label={__("Number of Stars", "md-resort")}
                value={reviewStars}
              ...
              />
              <PanelColorSettings
                title={__("Review Stars Colors", "md-resort")}
                initialOpen={false}
                colorSettings={[
                  {
                    ...
                    label: __("Stars Color", "md-resort"),
                  },
                  {
            ...
            colorSettings={[
              {
                ...
                label: __("Sub Title Color", "md-resort"),
              },
              {
                value: titleColor,
                onChange: (colorValue) =>
              ...
              },
              {
                ...
                label: __("Counter Number Color", "md-resort"),
              },
              {
                value: reviewTextColor,
                onChange: (colorValue) =>
                  setAttributes({ reviewTextColor: colorValue }),
                label: __("Review Text Color", "md-resort"),
              },
            ]}
          />
        </PanelBody>
