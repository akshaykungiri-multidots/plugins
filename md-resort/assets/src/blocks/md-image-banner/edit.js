    ...
    <div {...useBlockProps({ className: "md_resort_video_header_section" })}>
      <InspectorControls>
        ...
        <PanelBody title={__("Button Settings")} initialOpen={false}>
          <ToggleControl
            label={__("Show Button", "md-resort")}
            checked={showButton}
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                label: __("Years Text Color", "md-resort"),
              },
              {
                value: yearsSubTextColor,
                onChange: (colorValue) =>
                  setAttributes({ yearsSubTextColor: colorValue }),
                label: __("Years Sub Text Color", "md-resort"),
              },
              {
                value: linkTextColor,
                onChange: (colorValue) =>
                  setAttributes({ linkTextColor: colorValue }),
                label: __("Link Text Color", "md-resort"),
              },
            ]}
          />
        </PanelBody>
