        ...
        <PanelBody title={__("Color Settings")} initialOpen={false}>
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              {
                value: maskColor,
                onChange: (newColor) => setAttributes({ maskColor: newColor }),
                label: __("Mask Font Color"),
              },
              {
                value: maskBackgroundColor,
                onChange: (newColor) =>
                  setAttributes({ maskBackgroundColor: newColor }),
                label: __("Mask Background Color"),
              },
            ]}
          />
        </PanelBody>
          ...
          {slideItems.map((item, index) => (
            <div className={`md_slider_grid_item active"`} key={index}>
              <div className="md_slider__item_shape">
                <div className="md_slider__item_shape_1"></div>
                <div className="md_slider__item_shape_2"></div>
              </div>
              <div
              ...
              >
                ...
                {item.enableMask && (
                  <div className="md_slider__item__mask">
                    ...
                    >
                      <i className="bi bi-patch-check-fill icon-extra-medium"></i>
                      <RichText
                        tagName="p"
                        value={item.maskText}
                        onChange={(value) =>
                          updateStaticPostObj(index, "maskText", value)
                        }
          ...
          >
            <div className={`item-action-wrap show-items-hover pos-abs`}>
              <div className="move-item">
                {0 < index && (
                  <Tooltip text={__("Move Left", "md-resort")}>
                    <span
                ...
                {index + 1 < slideItems.length && (
                  <Tooltip text={__("Move Right", "md-resort")}>
                    <span
