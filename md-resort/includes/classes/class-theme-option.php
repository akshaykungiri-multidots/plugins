...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-resort', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-resort-theme-options">
				<div class="md-resort-theme-options-header">
					<h1>MD Resort Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-resort&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-resort' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-resort-setting' );
					do_settings_sections( 'md-resort' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-resort-setting', 'md_resort_settings' );
		add_settings_section( 'md-resort-section', __( 'General Settings', 'md-resort' ), '__return_empty_string', 'md-resort' );
		add_settings_field(
			'md_resort_logo',
			__( 'Site Logo:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'file',
				'name'  => 'md_resort_settings[md_resort_img]',
				'value' => 'md_resort_img',
			)
		);
		add_settings_field(
			'md_resort_favicon',
			__( 'Site Favicon:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'file',
				'name'  => 'md_resort_settings[md_resort_favicon]',
				'value' => 'md_resort_favicon',
			)
		);
		add_settings_field(
			'md_resort_tagline',
			__( 'Site Tagline:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'text',
				'name'  => 'md_resort_settings[md_resort_tagline]',
				'value' => 'md_resort_tagline',
			)
		);
		add_settings_field(
			'md_resort_google_analytic',
			__( 'Google Analytic:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_resort_settings[md_resort_google_analytic]',
				'value' => 'md_resort_google_analytic',
			)
		);
		add_settings_field(
			'md_resort_css_code',
			__( 'Additional CSS:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_resort_settings[md_resort_css_code]',
				'value' => 'md_resort_css_code',
			)
		);
		add_settings_field(
			'md_resort_html_code',
			__( 'Additional html:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_resort_settings[md_resort_html_code]',
				'value' => 'md_resort_html_code',
			)
		);
		add_settings_field(
			'md_resort_color_picker',
			__( 'Color:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_resort_settings[md_resort_color_picker]',
				'value' => 'md_resort_color_picker',
			)
		);
		add_settings_field(
			'md_resort_wysiwyg',
			__( 'Text Editor:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_resort_settings[md_resort_wysiwyg]',
				'value' => 'md_resort_wysiwyg',
			)
		);
		add_settings_field(
			'md_resort_password',
			__( 'Manage Password:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'password',
				'name'  => 'md_resort_settings[md_resort_password]',
				'id'    => 'password',
				'value' => 'md_resort_password',
			)
		);
		add_settings_field(
			'md_resort_selectbox',
			__( 'Select Option:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'    => 'select',
				'name'    => 'md_resort_settings[md_resort_selectbox]',
				'value'   => 'md_resort_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_resort_multiselect',
			__( 'Select Multiple Option:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_resort_settings[md_resort_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_resort_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_resort_radio',
			__( 'Select Radio Option:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_resort_settings[md_resort_radio]',
				'value'   => 'md_resort_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_resort_checkbox',
			__( 'Select Checkbox Option:', 'md-resort' ),
			array( $this, 'add_field' ),
			'md-resort',
			'md-resort-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_resort_settings[md_resort_checkbox]',
				'value' => 'md_resort_checkbox',
		...
		add_settings_field(
			...
			array(
				'type'  => 'number',
				'name'  => 'md_resort_settings[md_resort_number]',
				'value' => 'md_resort_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_resort_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		...
		<img class="md_resort_img" 
			...
			?>
		/>
		<input class="md_resort_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_resort_img_upload"><button>Upload</button></a>
		<a href="#" class="md_resort_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_RESORT_BUILD_URI . '/themeoption.css', array(), filemtime( MD_RESORT_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_RESORT_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_RESORT_BUILD_PATH . '/themeoption.js' ), true );
