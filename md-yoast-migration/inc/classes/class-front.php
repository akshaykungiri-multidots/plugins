 ...
 * @subpackage MD_Yoast_Migration/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-yoast-migration-front', MD_YOAST_MIGRATION_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'md-yoast-migration', MD_YOAST_MIGRATION_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
