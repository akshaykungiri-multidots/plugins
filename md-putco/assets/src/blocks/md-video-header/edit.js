...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_putco_video_header_section" })}>
      <InspectorControls>
        <PanelBody title={__("Video Settings", "md-putco")} initialOpen={true}>
        ...
        <PanelBody title={__("Text Settings", "md-putco")} initialOpen={false}>
          ...
          <Button
            ...
            className="components-button button button-large"
          >
            {__("Add Text", "md-putco")}
          </Button>
        </PanelBody>
        <PanelBody
          title={__("Background Settings", "md-putco")}
          initialOpen={false}
        >
        ...
        <PanelBody
          title={__("Toggle Settings", "md-putco")}
          initialOpen={false}
        >
          <ToggleControl
          ...
          />
          <ToggleControl
            label={__("Show Video Footer Text", "md-putco")}
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                label: __("Video Footer Text Color", "md-putco"),
              },
            ]}
          />
        </PanelBody>
      </InspectorControls>
      <div className="md_putco_text_video_wrap" style={{ backgroundImage: `url(${backgroundImage})` }}>
        <div
          className="md_putco_text_video"
          style={{
            background: `${backgroundColor}`,
          }}
        >
          <div
            className="md_putco_text_video__inner"
          >
            <div className="md_putco_text_video__heading">
              <h3
                className="md_putco_text_video__typing_title"
              ...
              >
                ...
                <span
                  className="md_putco_text_video__typing"
            ...
            <div className="md_putco_text_video__youtube">
              <div className="md_putco_text_video__youtube_icon">
                <button
              ...
              <div
                className={`putco_video_popup__wrap ${
                  displayPopup ? "show-popup" : ""
                }`}
              >
                <div className="putco_video_popup__inner">
                  <div className="putco_video_popup__inner-header">
                    <i
                  ...
                  <div className="putco_video_popup__inner-content">
                    <div className="text_video__youtube">
                      <div className="video_section_wrapper" id="MdYTplayer">
                        <div className="wrapper__box-inner">
                          <div
          ...
          <div className="md_putco_text_video__footer">
            {showVideoFooterText && (
              <RichText
                tagName="p"
                ...
                placeholder={__("Enter Footer Text", "md-putco")}
