...
(function () {
  ...
  const wordsToType = document
      .querySelector(".md_putco_text_video__typing")
      .getAttribute("data-typing-words")
      .split(","),
    typer = jQuery(".md_putco_text_video__typing"),
  ...
  jQuery(document).ready(function ($) {
    $(".md_putco_text_video__youtube_icon .play-button").on("click", function () {
      $(".putco_video_popup__wrap").addClass("show-popup");
    });
    $(".putco_video_popup__inner-header .close-popup").on("click", function () {
      $(".putco_video_popup__wrap").removeClass("show-popup");
    });
  });
})(jQuery);
