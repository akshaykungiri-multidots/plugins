...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps({ className: "md_putco_service_banner_section" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-putco")}>
          ...
          />
          <ToggleControl
            label={__("Show Counter Number", "md-putco")}
            checked={showCounterNumber}
            onChange={(value) => setAttributes({ showCounterNumber: value })}
          />
          <ToggleControl
            label={__("Show Review Text", "md-putco")}
            checked={showReviewText}
            onChange={(value) => setAttributes({ showReviewText: value })}
          />
        </PanelBody>
        <PanelBody
          title={__("Highlighted Text Settings", "md-putco")}
          initialOpen={false}
        >
          <ToggleControl
            label={__("Show Highlighted Text", "md-putco")}
          ...
          {showHighlightedText && (
            <Fragment>
              ...
              <PanelColorSettings
                title={__("Highlighted Text Colors", "md-putco")}
                initialOpen={false}
                colorSettings={[
                  {
                    ...
                    label: __("Text Color", "md-putco"),
                  },
                ]}
              />
              <div className="settings-row">
                <label htmlFor="highlightedTextColor">
                  {__("Highlighted Text Background Color", "md-putco")}
                </label>
                <GradientPicker
        ...
        <PanelBody
          title={__("Review Stars Settings", "md-putco")}
          initialOpen={false}
        >
          <ToggleControl
            label={__("Show Review Stars", "md-putco")}
          ...
          {showReviewStars && (
            <Fragment>
              <RangeControl
                label={__("Number of Stars", "md-putco")}
                value={reviewStars}
              ...
              />
              <PanelColorSettings
                title={__("Review Stars Colors", "md-putco")}
                initialOpen={false}
                colorSettings={[
                  {
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                label: __("Counter Number Color", "md-putco"),
              },
              {
                value: reviewTextColor,
                onChange: (colorValue) =>
                  setAttributes({ reviewTextColor: colorValue }),
                label: __("Review Text Color", "md-putco"),
              },
            ]}
          />
        </PanelBody>
      </InspectorControls>
      <div className={`md_putco_service_banner_wrap`}>
        <div className="md_putco_service_banner" style={{ backgroundColor }}>
          <div className="container">
            <div className="md_putco_service_banner__inner">
              <div className="md_putco_service_banner__heading">
                {showSubTitle && (
                  <RichText
                    tagName="h4"
                    value={subTitle}
                ...
                {showHeadingContent && (
                  <RichText
                    tagName="p"
                    className="md_putco_service_banner__content"
              ...
              {showHighlightedText && (
                <div
                  className="md_putco_service_banner__highlighted_text"
                  style={{
                ...
                >
                  ...
                  <RichText
                    ...
                    placeholder={__("Enter Highlighted Text", "md-putco")}
                  />
                </div>
              )}
              <div className="md_putco_service_banner__footer">
                <div className="md_putco_service_banner__footer_left">
                  {showCounterNumber && (
                    <div
                      className="md_putco_service_banner__counter"
                    ...
                    >
                      <RichText
                        ...
                        placeholder={__("Enter Counter Number", "md-putco")}
                      />
                    </div>
                  )}
                  {showReviewStars && (
                    <div
                      className="md_putco_service_banner__review_stars"
                      style={{
                ...
                <div className="md_putco_service_banner__footer_right">
                  {showReviewText && (
                    <div
                      className="md_putco_service_banner__review_text"
                    ...
                    >
                      <RichText
                        ...
                        placeholder={__("Enter Review Text", "md-putco")}
                      />
                    </div>
                  )}
                </div>
