...
export default function Edit({ attributes, setAttributes, className }) {
  ...
  useEffect(() => {
    wp.apiFetch({ path: "md-putco/v1/service-posts" }).then((data) => {
      setServiceData(data);
    });
  }, []);
    ...
    <div {...useBlockProps()}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-putco")}>
          <ToggleControl
            label={__("Show Heading", "md-putco")}
            checked={showHeading}
            onChange={(value) => setAttributes({ showHeading: value })}
          />
          <ToggleControl
            label={__("Show Sub Heading", "md-putco")}
            checked={showSubHeading}
            onChange={(value) => setAttributes({ showSubHeading: value })}
          />
          <ToggleControl
            label={__("Show Content", "md-putco")}
            checked={showContent}
            onChange={(value) => setAttributes({ showContent: value })}
          />
          <ToggleControl
            label={__("Show Footer", "md-putco")}
            checked={showFooter}
            ...
            colorSettings={[
              {
                ...
                label: __("Sub Heading Color", "md-putco"),
              },
              {
                value: headingColor,
                onChange: (colorValue) =>
                  setAttributes({ headingColor: colorValue }),
                label: __("Heading Color", "md-putco"),
              },
              {
                value: contentColor,
                onChange: (colorValue) =>
          ...
          <div className="service-slider__content">
            <div className="service-slider__heading_wrapper">
              {showSubHeading && (
                <RichText
                  ...
                  placeholder={__("Sub Heading", "md-putco")}
              ...
              {showHeading && (
                <RichText
                  ...
                  placeholder={__("Heading", "md-putco")}
            ...
            {showContent && (
              <RichText
                ...
                placeholder={__("Content", "md-putco")}
        ...
        {showFooter && (
          <div className="service-slider__footer">
            ...
            <RichText
              ...
              placeholder={__("Footer Text", "md-putco")}
