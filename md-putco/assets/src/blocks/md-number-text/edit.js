  ...
  return (
    ...
    >
      <InspectorControls>
        ...
        <PanelBody
          title={__("Color Settings", "md-putco-fse-full")}
          initialOpen={false}
        >
          <PanelColorSettings
            title={__("Color Settings", "md-putco-fse-full")}
      ...
      <style>
        {`
          .putco-stat-number__inner__item:last-child {
            border-right: none !important;
          }
        `}
      </style>
      <div className={`putco-stat-number ${enableBorder ? "none" : "top"}`}>
        <div className="container">
          <div
            className="putco-stat-number__inner"
            style={{
              backgroundColor,
            }}
          >
            {columnList &&
              columnList.map((postObj, index) => (
                <div
                  className="putco-stat-number__inner__item fadeInUp show-items-hover-wrap"
                  key={index}
                  style={{
                    width: `${100 / columns}%`,
                    borderColor,
