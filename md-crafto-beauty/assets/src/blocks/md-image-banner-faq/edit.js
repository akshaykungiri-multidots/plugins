    ...
    >
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-crafto-beauty")}>
          ...
          />
          <ToggleControl
            label={__("Show Beauty Tips", "md-crafto-beauty")}
            checked={showBeautyTips}
            onChange={(value) => setAttributes({ showBeautyTips: value })}
          />
          <ToggleControl
            label={__("Show FAQ", "md-crafto-beauty")}
            checked={showFaq}
      ...
      >
        ...
        >
          <div className="container">
            ...
            >
              <div className="md_crafto_beauty_image_banner_faqs__heading">
                {showSubTitle && (
                  <RichText
                    tagName="h4"
                    value={subTitle}
                ...
                <div className="md_crafto_beauty_faqs__wrapper">
                ...
                <div className="md_crafto_beauty_image_banner_faqs__btn_wrapper">
                  {showButton && (
                    <div className="btn-anitian md_crafto_beauty_image_banner_faqs__btn md-btn-main btn-extra-large has-right-arrow">
                      <RichText
                        tagName="span"
                        value={buttonLink}
                        onChange={(value) =>
              ...
              <div className="md-prime-block-control image-preview image-controle-visible-hover md_crafto_beauty_image_banner_faqs__media">
        ...
        {showBeautyTips && (
          <div className="md_crafto_beauty_image_banner__beauty_tips_wrap">
            <div className="container">
              <div className="md_crafto_beauty_image_banner__beauty_tips">
                <div className="md_crafto_beauty_image_banner__awesome_text">
                  <RichText
                    ...
                    placeholder={__("Enter Beauty Tips", "md-crafto-beauty")}
