...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-crafto-beauty', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-crafto-beauty-theme-options">
				<div class="md-crafto-beauty-theme-options-header">
					<h1>MD Crafto Beauty Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-crafto-beauty&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-crafto-beauty' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-crafto-beauty-setting' );
					do_settings_sections( 'md-crafto-beauty' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-crafto-beauty-setting', 'md_crafto_beauty_settings' );
		add_settings_section( 'md-crafto-beauty-section', __( 'General Settings', 'md-crafto-beauty' ), '__return_empty_string', 'md-crafto-beauty' );
		add_settings_field(
			'md_crafto_beauty_logo',
			__( 'Site Logo:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'file',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_img]',
				'value' => 'md_crafto_beauty_img',
			)
		);
		add_settings_field(
			'md_crafto_beauty_favicon',
			__( 'Site Favicon:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'file',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_favicon]',
				'value' => 'md_crafto_beauty_favicon',
			)
		);
		add_settings_field(
			'md_crafto_beauty_tagline',
			__( 'Site Tagline:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'text',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_tagline]',
				'value' => 'md_crafto_beauty_tagline',
			)
		);
		add_settings_field(
			'md_crafto_beauty_google_analytic',
			__( 'Google Analytic:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_google_analytic]',
				'value' => 'md_crafto_beauty_google_analytic',
			)
		);
		add_settings_field(
			'md_crafto_beauty_css_code',
			__( 'Additional CSS:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_css_code]',
				'value' => 'md_crafto_beauty_css_code',
			)
		);
		add_settings_field(
			'md_crafto_beauty_html_code',
			__( 'Additional html:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'textarea',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_html_code]',
				'value' => 'md_crafto_beauty_html_code',
			)
		);
		add_settings_field(
			'md_crafto_beauty_color_picker',
			__( 'Color:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'color-picker',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_color_picker]',
				'value' => 'md_crafto_beauty_color_picker',
			)
		);
		add_settings_field(
			'md_crafto_beauty_wysiwyg',
			__( 'Text Editor:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'wysiwyg',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_wysiwyg]',
				'value' => 'md_crafto_beauty_wysiwyg',
			)
		);
		add_settings_field(
			'md_crafto_beauty_password',
			__( 'Manage Password:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'password',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_password]',
				'id'    => 'password',
				'value' => 'md_crafto_beauty_password',
			)
		);
		add_settings_field(
			'md_crafto_beauty_selectbox',
			__( 'Select Option:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'    => 'select',
				'name'    => 'md_crafto_beauty_settings[md_crafto_beauty_selectbox]',
				'value'   => 'md_crafto_beauty_selectbox',
				'options' => array(
					'0' => '0',
					'1' => '1',
					'2' => '2',
		...
		add_settings_field(
			'md_crafto_beauty_multiselect',
			__( 'Select Multiple Option:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'    => 'multicheck',
				'name'    => 'md_crafto_beauty_settings[md_crafto_beauty_multiselect]',
				'id'      => 'multicheck',
				'value'   => 'md_crafto_beauty_multiselect',
				'options' => array(
					'0' => 'pizza',
					'1' => 'biryani',
					'2' => 'burger',
		...
		add_settings_field(
			'md_crafto_beauty_radio',
			__( 'Select Radio Option:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'    => 'radio',
				'name'    => 'md_crafto_beauty_settings[md_crafto_beauty_radio]',
				'value'   => 'md_crafto_beauty_radio',
				'options' => array(
					'0' => 'HTML',
					'1' => 'CSS',
					'2' => 'JS',
		...
		add_settings_field(
			'md_crafto_beauty_checkbox',
			__( 'Select Checkbox Option:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'checkbox',
				'id'    => 'checkbox',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_checkbox]',
				'value' => 'md_crafto_beauty_checkbox',
				'task'  => 'Enable Transparent Header ?',
			)
		);
		add_settings_field(
			'md_crafto_beauty_number',
			__( 'Number:', 'md-crafto-beauty' ),
			array( $this, 'add_field' ),
			'md-crafto-beauty',
			'md-crafto-beauty-section',
			array(
				'type'  => 'number',
				'name'  => 'md_crafto_beauty_settings[md_crafto_beauty_number]',
				'value' => 'md_crafto_beauty_number',
			)
		);
	}
	...
	public function add_field( array $args ) {
		$options = get_option( 'md_crafto_beauty_settings' );
		switch ( $args['type'] ) {
			case 'text':
	...
	public function file_callback( $args, $options ) {
		?>
		<img class="md_crafto_beauty_img" 
			...
			?>
		/>
		<input class="md_crafto_beauty_img_url" 
			type="hidden" 
			name="<?php echo esc_attr( $args['name'] ); ?>" 
			size="60" 
			value="<?php echo isset( $options[ $args['value'] ] ) ? esc_attr( $options[ $args['value'] ] ) : ''; ?>"
		>
		<a href="#" class="md_crafto_beauty_img_upload"><button>Upload</button></a>
		<a href="#" class="md_crafto_beauty_img_remove"><button>Remove</button></a>
		<?php
	}
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_CRAFTO_BEAUTY_BUILD_URI . '/themeoption.css', array(), filemtime( MD_CRAFTO_BEAUTY_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_CRAFTO_BEAUTY_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_CRAFTO_BEAUTY_BUILD_PATH . '/themeoption.js' ), true );
