...
class Register_Post_Types
{
	...
	public function register_service_cpt()
	{
		...
		$labels = array(
			'name'                  => _x('Services', 'Post Type General Name', 'md-crafto-beauty'),
			'singular_name'         => _x('Service', 'Post Type Singular Name', 'md-crafto-beauty'),
			'menu_name'             => _x('Services', 'Admin Menu text', 'md-crafto-beauty'),
			'name_admin_bar'        => _x('Service', 'Add New on Toolbar', 'md-crafto-beauty'),
			'archives'              => __('Service Archives', 'md-crafto-beauty'),
			'attributes'            => __('Service Attributes', 'md-crafto-beauty'),
			'parent_item_colon'     => __('Parent Service:', 'md-crafto-beauty'),
			'all_items'             => __('All Services', 'md-crafto-beauty'),
			'add_new_item'          => __('Add New Service', 'md-crafto-beauty'),
			'add_new'               => __('Add New', 'md-crafto-beauty'),
			'new_item'              => __('New Service', 'md-crafto-beauty'),
			'edit_item'             => __('Edit Service', 'md-crafto-beauty'),
			'update_item'           => __('Update Service', 'md-crafto-beauty'),
			'view_item'             => __('View Service', 'md-crafto-beauty'),
			'view_items'            => __('View Services', 'md-crafto-beauty'),
			'search_items'          => __('Search Service', 'md-crafto-beauty'),
			'not_found'             => __('Not found', 'md-crafto-beauty'),
			'not_found_in_trash'    => __('Not found in Trash', 'md-crafto-beauty'),
			'featured_image'        => __('Featured Image', 'md-crafto-beauty'),
			'set_featured_image'    => __('Set featured image', 'md-crafto-beauty'),
			'remove_featured_image' => __('Remove featured image', 'md-crafto-beauty'),
			'use_featured_image'    => __('Use as featured image', 'md-crafto-beauty'),
			'insert_into_item'      => __('Insert into Service', 'md-crafto-beauty'),
			'uploaded_to_this_item' => __('Uploaded to this Service', 'md-crafto-beauty'),
			'items_list'            => __('Services list', 'md-crafto-beauty'),
			'items_list_navigation' => __('Services list navigation', 'md-crafto-beauty'),
			'filter_items_list'     => __('Filter Services list', 'md-crafto-beauty'),
		);
		$args   = array(
			'label'               => __('Service', 'md-crafto-beauty'),
			'description'         => __('The service', 'md-crafto-beauty'),
			'labels'              => $labels,
	...
	public function add_service_metabox()
	{
		add_meta_box(
			'service_metabox',
			__('Service Details', 'md-crafto-beauty'),
	...
	public function service_metabox_callback($post)
	{
		...
		echo '<tr>';
		echo '<th><label for="service_icon" class="service_icon_label">' . __('Service Icon', 'md-crafto-beauty') . '</label></th>';
		echo '<td>';
		echo '<input type="text" id="service_icon" name="service_icon" class="service_icon_field" value="' . esc_attr($service_icon) . '" size="25" />';
		echo '<p class="description">' . __('Enter the service icon', 'md-crafto-beauty') . '</p>';
		echo '</td>';
		echo '</tr>';

		echo '<tr>';
		echo '<th><label for="service_subtitle" class="service_subtitle_label">' . __('Service Subtitle', 'md-crafto-beauty') . '</label></th>';
		echo '<td>';
		...
		echo '<p class="description">' . __('Enter the service subtitle', 'md-crafto-beauty') . '</p>';
		echo '</td>';
		echo '</tr>';
		echo '</table>';
	}
	...
	public function likes_metabox_callback($post)
	{
		...
		echo '<table class="form-table">';
		echo '<tr>';
		echo '<th><label for="likes" class="likes_label">' . esc_html__('Number of Likes', 'md-crafto-beauty') . '</label></th>';
		echo '<td>';
		echo '<input type="text" id="likes" name="likes" class="likes_field" value="' . esc_attr($likes) . '" size="25" />';
		echo '<p class="description">' . esc_html__('Enter the number of likes.', 'md-crafto-beauty') . '</p>';
		echo '</td>';
		echo '</tr>';
		echo '</table>';
	}
