 ...
 * @subpackage MD_Partner_Program/public
...
class Front {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'md-partner-program-front', MD_PARTNER_PROGRAM_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'md-partner-program', MD_PARTNER_PROGRAM_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
