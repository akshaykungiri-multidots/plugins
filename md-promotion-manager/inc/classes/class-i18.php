...
class I18 {
	 ...
	 *
	 * Uses the MD_Promotion_Manager_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	public function set_locale() {
		...
		$locale = apply_filters( 'plugin_locale', get_locale(), 'md-promotion-manager' );
		load_textdomain( 'md-promotion-manager', plugin_dir_path( dirname( __FILE__ ) ) . '/languages/' . $locale . '.mo' );
