  ...
  return (
    <div {...useBlockProps.save()}>
      <div className={"md_number_block " + logosAlignment}>
        ...
        {showLogos && (
          <div className={`md_number_block__slider_wrap ` + logoStyle}>
              ...
              {logos &&
                logos.map((postObj, index) => (
                  ...
                  >
                    <div
                      className={
                        "md-pofomd_number_block__item-icon " + logosAlignment
                      }
                      style={{ border: enableBorder ? "1px solid" : "none" }}
                    >
                      <div className="md-pofomd_number_block__item-icon__wrapper">
                        <div className="md-pofomd_number_block__item-icon__wrapper-heading">
                        ...
                        <div className="md-pofomd_number_block__item-icon__wrapper-text">
                          {showLogosDescription && (
                            <RichText.Content
                              tagName="p"
                          ...
                          <div className="md-pofomd_number_block__item-icon__wrapper--horizontal-line"></div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        {showButton && (
          <div className="md_number_block__button">
            <RichText.Content
              tagName="p"
              className="button"
              value={buttonText}
