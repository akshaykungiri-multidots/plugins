...
export default function Edit({ attributes, setAttributes }) {
  ...
  const addStaticCategory = () => {
    ...
    setAttributes({ categories: staticCategoryObj });
  };
  const updateStaticCategory = (index, key, value) => {
    ...
    setAttributes({ categories: updatedStaticCategoryObj });
  };
    ...
    <div {...useBlockProps({ className: "md_portfolio_section" })}>
      <InspectorControls>
        <PanelBody title={__("Portfolio Settings")}>
          ...
          />
          <ToggleControl
            label={__("Show Category in Portfolio")}
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                onChange: (colorValue) =>
                  setAttributes({ portfolioCategoryColor: colorValue }),
                label: __("Portfolio Category Color"),
              },
            ]}
          />
                  ...
                  >
                    ...
                    >
                      <div className="move-item">
                        {0 < index && (
                          <Tooltip text={__("Move Left", "md-pofo")}>
                            <span
                        ...
                        {index + 1 < categories.length && (
                          <Tooltip text={__("Move Right", "md-pofo")}>
                            <span
                    ...
                    <RichText
                      ...
                      value={category.name}
                      onChange={(value) =>
                        updateStaticCategory(index, "name", value)
                      }
            ...
            {portfolioItems.map((item, index) => (
              <div
                ...
                className={
                  ...
                  (currentCategory === "" ||
                  currentCategory === item.portfolioCategory
                    ? "active"
                    : "")
                }
                style={{
              ...
              >
                ...
                <div className="md_portfolio_item_inner">
                  ...
                  <div className="md_portfolio_item_inner__content">
                    ...
                    />
                    <div className="md_portfolio_item_inner__content__category">
                      {showCategoryInPortfolio && (
                        <SelectControl
                          label={__("Category")}
