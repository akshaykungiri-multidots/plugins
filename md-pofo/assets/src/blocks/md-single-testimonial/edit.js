    ...
    <div {...useBlockProps({ className: "md_pofo_video_header_section" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-pofo")}>
          ...
          />
          <ToggleControl
            label={__("Show Signature Image", "md-pofo")}
            checked={showSignatureImage}
            onChange={(value) => setAttributes({ showSignatureImage: value })}
          />
          <ToggleControl
            label={__("Show Author Name", "md-pofo")}
            checked={showAuthorName}
            onChange={(value) => setAttributes({ showAuthorName: value })}
          />
          <ToggleControl
            label={__("Show Author Position", "md-pofo")}
          ...
          <PanelColorSettings
            ...
            colorSettings={[
              ...
              },
              {
                ...
                label: __("Author Name Color", "md-pofo"),
              },
              {
                value: authorPositionColor,
                onChange: (colorValue) =>
                  setAttributes({ authorPositionColor: colorValue }),
                label: __("Author Position Color", "md-pofo"),
              },
            ]}
          />
        </PanelBody>
                  ...
                  <div className="md-prime-block-control image-preview image-controle-visible-hover">
                    ...
                    >
                      <MediaUploadCheck>
                        <MediaUpload
                          onSelect={(media) =>
                            setAttributes({ signatureImage: media.url })
                          }
                          allowedTypes={["image"]}
                    ...
                    <img src={signatureImage || siteURL + placeholder} alt="" />
                  </div>
                </div>
              )}
