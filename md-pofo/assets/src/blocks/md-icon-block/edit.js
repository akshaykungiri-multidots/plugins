...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...useBlockProps()}>
      ...
      <div className={"md_icon_block " + logosAlignment}>
        ...
        {showLogos && (
          <div className={`md_icon_block__slider_wrap ` + logoStyle}>
              ...
              {logos &&
                logos.map((postObj, index) => (
                  ...
                  >
                    ...
                    <div className={"md-pofomd_icon_block__item-icon " + logosAlignment} style={{border: enableBorder ? "1px solid" : "none"}}>
                      {showLogosIcon && (
                        <div className="md-pofomd_icon_block__item-icon-inner">
                          <SelectControl
                      ...
                      <div className="md-pofomd_icon_block__item-icon__wrapper">
                        {showLogosIcon && (
                          <div className="md-pofomd_icon_block__item-icon__wrapper-icon" style={{backgroundColor: logoIconBackgroundColor}}>
                            <i
                        ...
                        <div className="md-pofomd_icon_block__item-icon__wrapper-text">
                          {showLogosTitle && (
                            <RichText
                              tagName="h4"
                          ...
                          {showLogosReadMore && (
                            <RichText
                              ...
                              onChange={(value) =>
                                updateStaticPostObj(index, "readMoreText", value)
                              }
