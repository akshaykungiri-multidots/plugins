...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)("blocks.registerBlockType", "custom/navigation-link-add-post-selection", addPostSelectionAttribute);
...
const addPostSelectionControl = BlockEdit => props => {
  ...
  const posts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    return select("core").getEntityRecords("postType", 'md-menu-block', {
      per_page: -1,
      _fields: "id,title"
    }) || [];
  }, []);
  const postOptions = [{
    value: 0,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Select a Post", "md-woodward")
  }, ...posts.map(post => ({
    value: post.id,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(BlockEdit, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Post Selection", "md-woodward"),
        initialOpen: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
          ...
          onChange: newValue => {
            ...
            const selectedPostData = posts.find(post => post.id === selectedPostId);
            if (selectedPostData) {
              setAttributes({
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)("editor.BlockEdit", "custom/navigation-link-add-post-selection-control", addPostSelectionControl);
})();
