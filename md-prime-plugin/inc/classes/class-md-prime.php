 ...
 * @since      1.0.0
 * @package    MD_Prime
 * @subpackage MD_Prime/includes
 * @author     Multidots <info@multidots.com>
 */

namespace MD_Prime\Inc;

use MD_Prime\Inc\Blocks;
...
class MD_Prime {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      MD_Prime_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
