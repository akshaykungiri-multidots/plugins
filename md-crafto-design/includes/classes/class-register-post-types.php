...
class Register_Post_Types
{
	...
	public function register_service_cpt()
	{
		...
		$labels = array(
			'name'                  => _x('Services', 'Post Type General Name', 'md-crafto-design'),
			'singular_name'         => _x('Service', 'Post Type Singular Name', 'md-crafto-design'),
			'menu_name'             => _x('Services', 'Admin Menu text', 'md-crafto-design'),
			'name_admin_bar'        => _x('Service', 'Add New on Toolbar', 'md-crafto-design'),
			'archives'              => __('Service Archives', 'md-crafto-design'),
			'attributes'            => __('Service Attributes', 'md-crafto-design'),
			'parent_item_colon'     => __('Parent Service:', 'md-crafto-design'),
			'all_items'             => __('All Services', 'md-crafto-design'),
			'add_new_item'          => __('Add New Service', 'md-crafto-design'),
			'add_new'               => __('Add New', 'md-crafto-design'),
			'new_item'              => __('New Service', 'md-crafto-design'),
			'edit_item'             => __('Edit Service', 'md-crafto-design'),
			'update_item'           => __('Update Service', 'md-crafto-design'),
			'view_item'             => __('View Service', 'md-crafto-design'),
			'view_items'            => __('View Services', 'md-crafto-design'),
			'search_items'          => __('Search Service', 'md-crafto-design'),
			'not_found'             => __('Not found', 'md-crafto-design'),
			'not_found_in_trash'    => __('Not found in Trash', 'md-crafto-design'),
			'featured_image'        => __('Featured Image', 'md-crafto-design'),
			'set_featured_image'    => __('Set featured image', 'md-crafto-design'),
			'remove_featured_image' => __('Remove featured image', 'md-crafto-design'),
			'use_featured_image'    => __('Use as featured image', 'md-crafto-design'),
			'insert_into_item'      => __('Insert into Service', 'md-crafto-design'),
			'uploaded_to_this_item' => __('Uploaded to this Service', 'md-crafto-design'),
			'items_list'            => __('Services list', 'md-crafto-design'),
			'items_list_navigation' => __('Services list navigation', 'md-crafto-design'),
			'filter_items_list'     => __('Filter Services list', 'md-crafto-design'),
		);
		$args   = array(
			'label'               => __('Service', 'md-crafto-design'),
			'description'         => __('The service', 'md-crafto-design'),
			'labels'              => $labels,
	...
	public function add_service_metabox()
	{
		add_meta_box(
			'service_metabox',
			__('Service Details', 'md-crafto-design'),
	...
	public function service_metabox_callback($post)
	{
		...
		echo '<tr>';
		echo '<th><label for="service_icon" class="service_icon_label">' . __('Service Icon', 'md-crafto-design') . '</label></th>';
		echo '<td>';
		echo '<input type="text" id="service_icon" name="service_icon" class="service_icon_field" value="' . esc_attr($service_icon) . '" size="25" />';
		echo '<p class="description">' . __('Enter the service icon', 'md-crafto-design') . '</p>';
		echo '</td>';
		echo '</tr>';

		echo '<tr>';
		echo '<th><label for="service_subtitle" class="service_subtitle_label">' . __('Service Subtitle', 'md-crafto-design') . '</label></th>';
		echo '<td>';
		...
		echo '<p class="description">' . __('Enter the service subtitle', 'md-crafto-design') . '</p>';
		echo '</td>';
		echo '</tr>';
		echo '</table>';
	}
	...
	public function likes_metabox_callback($post)
	{
		...
		echo '<table class="form-table">';
		echo '<tr>';
		echo '<th><label for="likes" class="likes_label">' . esc_html__('Number of Likes', 'md-crafto-design') . '</label></th>';
		echo '<td>';
		echo '<input type="text" id="likes" name="likes" class="likes_field" value="' . esc_attr($likes) . '" size="25" />';
		echo '<p class="description">' . esc_html__('Enter the number of likes.', 'md-crafto-design') . '</p>';
		echo '</td>';
		echo '</tr>';
		echo '</table>';
	}
