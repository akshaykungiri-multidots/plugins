    ...
    >
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-crafto-design")}>
          ...
          />
          <ToggleControl
            label={__("Show Process", "md-crafto-design")}
            checked={showProcess}
