...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`md_crafto_design_image_banner_wrap`}
        style={{
      ...
      >
        <style>
          {`
            .md_crafto_design_image_banner__btn {
              color: ${buttonColor};
              background: ${buttonBackgroundColor};
            }
            .md_crafto_design_image_banner__btn:hover {
        ...
        <div
          className="md_crafto_design_image_banner"
          style={{ backgroundColor }}
        >
          <div className="container">
            <div
              className="md_crafto_design_image_banner__inner"
              style={{
                flexDirection: mediaPosition === "left" ? "row-reverse" : "row",
              }}
            >
              <div className="md_crafto_design_image_banner__heading">
                {showSubTitle && (
                  <RichText
                    tagName="h4"
                    value={subTitle}
                ...
                <div className="md_crafto_design_image_banner__btn_wrapper">
                  {showButton && (
                    <div className="btn-anitian md_crafto_design_image_banner__btn md-btn-main btn-extra-large has-right-arrow">
                      <RichText
                        tagName="span"
                        value={buttonLink}
                        onChange={(value) =>
        ...
        {showAwesomeText && (
          <div className="md_crafto_design_image_banner__awesome_text">
            <RichText
              ...
              placeholder={__("Enter Awesome Text", "md-crafto-design")}
              style={{ color: awesomeTextColor }}
            />
          </div>
        )}
      </div>
      <div className="md_crafto_design_image_banner__feature_box">
        {showFeatureBox && (
          <div className="md_crafto_design_image_banner__feature_box_inner">
            <div className="md_crafto_design_image_banner__feature_box_icon">
            ...
            <div className="md_crafto_design_image_banner__feature_box_content">
              <RichText
                tagName="h4"
                value={featureBoxTitle}
                onChange={(value) => setAttributes({ featureBoxTitle: value })}
                placeholder={__("Enter Feature Box Title", "md-crafto-design")}
              ...
              <RichText
                ...
                placeholder={__("Enter Feature Box Content", "md-crafto-design")}
        ...
        {showFeatureLink && (
          <div className="md_crafto_design_image_banner__feature_link">
            <RichText
              tagName="p"
              value={featureLink}
              onChange={(value) => setAttributes({ featureLink: value })}
              placeholder={__("Enter Feature Box Link", "md-crafto-design")}
