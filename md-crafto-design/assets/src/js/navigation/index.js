...
(function ($) {
  ...
  $(window).scroll(function () {
    if ($(window).scrollTop() >= 67) {
      $(".md-crafto-design-header").addClass("fixed-header");
    } else {
      $(".md-crafto-design-header").removeClass("fixed-header");
    }
  });
  ...
  function mdCreateSlickSlider() {
    ...
    $(".md_customer_stories_section__heading__avatars__container")
      .find(".md_slider")
      .each(function () {
        const autoplay = $(this).data("autoplay");
        const autoplaySpeed = $(this).data("autoplayspeed");
