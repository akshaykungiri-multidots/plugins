...
/**
 * Title: Post Sidebar
 * Slug: md-crafto-design/post-sidebar
 * Categories: sidebar
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Recent Posts', 'md-crafto-design' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Recent Comments', 'md-crafto-design' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Categorise', 'md-crafto-design' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Archive', 'md-crafto-design' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Tags', 'md-crafto-design' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
