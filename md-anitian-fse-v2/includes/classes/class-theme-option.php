...
class Theme_Option {
	...
	public function add_option_menu() {
		add_menu_page( 'Theme Options', 'Theme Options', 'manage_options', 'md-anitian-fse-v2', array( $this, 'option_form' ), '', 50 );
	}
	...
	public function option_form() {
		?>
		<div class="wrap">
			<div class="md-anitian-fse-v2-theme-options">
				<div class="md-anitian-fse-v2-theme-options-header">
					<h1>MD Anitian Fse V2 Theme Options</h1>
					<?php
					...
					<h2 class="nav-tab-wrapper">
						<a href="?page=md-anitian-fse-v2&tab=general_options" class="nav-tab <?php echo esc_attr( 'general_options' === $active_tab ? 'nav-tab-active' : '' ); ?>"><?php echo esc_html__( 'General Settings', 'md-anitian-fse-v2' ); ?></a>
					</h2>
					<span><?php settings_errors(); ?></span>
				</div>
				<form action='options.php' enctype="multipart/form-data" method='post'> 
					<?php
					settings_fields( 'md-anitian-fse-v2-setting' );
					do_settings_sections( 'md-anitian-fse-v2' );
					submit_button();
					?>
				</form>
			</div>
	...
	public function option_settings_init() {
		register_setting( 'md-anitian-fse-v2-setting', 'md_anitian_fse_full_settings' );
		add_settings_section( 'md-anitian-fse-v2-section', __( 'General Settings', 'md-anitian-fse-v2' ), '__return_empty_string', 'md-anitian-fse-v2' );
		add_settings_field(
			'md_anitian_fse_full_logo',
			__( 'Site Logo:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
				'type'  => 'file',
		...
		add_settings_field(
			...
			__( 'Site Favicon:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Site Tagline:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Google Analytic:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Additional CSS:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Additional html:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Text Editor:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Manage Password:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Select Option:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Select Multiple Option:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Select Radio Option:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
		...
		add_settings_field(
			...
			__( 'Select Checkbox Option:', 'md-anitian-fse-v2' ),
			array( $this, 'add_field' ),
			'md-anitian-fse-v2',
			'md-anitian-fse-v2-section',
			array(
	...
	public function theme_option_assets() {
		...
		// Register styles.
		wp_register_style( 'theme-option-css', MD_ANITIAN_FSE_V2_BUILD_URI . '/themeoption.css', array(), filemtime( MD_ANITIAN_FSE_V2_BUILD_PATH . '/themeoption.css' ), 'all' );
		...
		wp_register_script( 'theme-option-js', MD_ANITIAN_FSE_V2_BUILD_URI . '/themeoption.js', array( 'jquery-core', 'wp-color-picker' ), filemtime( MD_ANITIAN_FSE_V2_BUILD_PATH . '/themeoption.js' ), true );
