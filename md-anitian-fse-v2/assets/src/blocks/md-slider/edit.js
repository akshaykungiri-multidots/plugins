        ...
        {currentSlide >= 0 && (
          <PanelBody title={__("Current Slide Settings")} initialOpen={false}>
            <ToggleControl
              ...
              onChange={() =>
                updateStaticPostObj(currentSlide, "backgroundType", !slideItems[currentSlide].backgroundType)
              }
            />
            {slideItems[currentSlide].backgroundType ? (
              ...
              <div className="setting-row">
                <label htmlFor="box-background-color">
                  {__("Background Color")}
                </label>
                <GradientPicker
                  id="box-background-color"
                  value={
                    slideItems[currentSlide].backgroundColor !== undefined
                      ? slideItems[currentSlide].backgroundColor
                      : null
                  }
                  label={__("Box Color")}
                  onChange={(color) =>
                    updateStaticPostObj(currentSlide, "backgroundColor", color)
                  }
                  gradients={[
                    {
                      name: "gradient1",
          ...
          >
            <div className={`item-action-wrap show-items-hover pos-abs`}>
              <div className="move-item">
                {0 < index && (
                  <Tooltip text={__("Move Left", "md-anitian-fse-v2")}>
                    <span
                ...
                {index + 1 < slideItems.length && (
                  <Tooltip text={__("Move Right", "md-anitian-fse-v2")}>
                    <span
