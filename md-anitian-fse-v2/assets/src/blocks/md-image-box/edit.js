    ...
    <div {...useBlockProps({ className: "md_anitian_image_boxes_section" })}>
      <InspectorControls>
        <PanelBody title={__("Block Settings", "md-anitian-fse-v2")}>
          <ToggleControl
            label={__("Enable Slider", "md-anitian-fse-v2")}
          ...
          />
          <ToggleControl
            label={__("Show Image Box Content", "md-anitian-fse-v2")}
            checked={showImageBoxContent}
            onChange={(value) => setAttributes({ showImageBoxContent: value })}
          />
          <ToggleControl
            label={__("Show Image Box Button", "md-anitian-fse-v2")}
            ...
            <div className="container">
              <div className="bakery_antian__heading">
                ...
                <RichText
                  ...
                  placeholder={__("Enter Sub Heading", "md-anitian-fse-v2")}
                  style={{
                ...
                <RichText
                  ...
                  placeholder={__("Enter Heading", "md-anitian-fse-v2")}
