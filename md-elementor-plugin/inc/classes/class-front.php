 ...
 * @subpackage MD_Elementor/public
...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'md-elementor-front', MD_ELEMENTOR_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'md-elementor', MD_ELEMENTOR_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
