 ...
 * @subpackage MD_Elementor/includes
 * @author     Multidots <info@multidots.com>
 */

namespace MD_Elementor\Inc;

use MD_Elementor\Inc\Blocks;
...
class MD_Elementor {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      MD_Elementor_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
