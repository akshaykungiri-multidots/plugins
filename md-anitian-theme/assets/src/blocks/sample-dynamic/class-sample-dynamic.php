<?php
/**
 * Registers the md-anitian/sample-dynamic block.
 *
...
/**
 *  Class for the md-anitian/sample-dynamic block.
 */
class Sample_Dynamic extends Block_Base {
	...
	protected function setup_hooks() {
		add_filter( 'md_anitian_gutenberg_blocks_config', array( $this, 'localize_block_data' ) );
	}
