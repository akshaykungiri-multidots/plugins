...
/**
 * Title: Post Sidebar
 * Slug: md-efi-fse-full/post-sidebar
 * Categories: sidebar
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Recent Posts', 'md-efi-fse-full' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Recent Comments', 'md-efi-fse-full' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php echo esc_html__( 'Archive', 'md-efi-fse-full' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
